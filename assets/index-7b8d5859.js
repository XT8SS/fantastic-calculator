 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tu="FirebaseError";class zn extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=Tu,Object.setPrototypeOf(this,zn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ul.prototype.create)}}class ul{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?Nu(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new zn(i,a,s)}}function Nu(t,e){return t.replace(Du,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const Du=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ac=Ic;function _l(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:oi,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw bt.create("bad-app-name",{appName:String(i)});if(n||(n=ol()),!n)throw bt.create("no-options");const r=as.get(i);if(r){if(ni(n,r.options)&&ni(s,r.config))return r;throw bt.create("duplicate-app",{appName:i})}const o=new qu(i);for(const l of li.values())o.addComponent(l);const a=new Rc(n,s,o);return as.set(i,a),a}function Pc(t=oi){const e=as.get(t);if(!e&&t===oi&&ol())return _l();if(!e)throw bt.create("no-app",{appName:t});return e}function tn(t,e,n){var s;let i=(s=Tc[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ht.warn(a.join(" "));return}us(new Dn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wl{constructor(e){this.allowedEvents_=e,this.listeners_={},B(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const s=[...this.listeners_[e]];for(let i=0;i<s.length;i++)s[i].callback.apply(s[i].context,n)}}on(e,n,s){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:s});const i=this.getInitialEvent(e);i&&n.apply(s,i)}off(e,n,s){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let r=0;r<i.length;r++)if(i[r].callback===n&&(!s||s===i[r].context)){i.splice(r,1);return}}validateEventType_(e){B(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ds extends Wl{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!ll()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new ds}getInitialEvent(e){return B(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let di;function Vd(t){di=t}const Yl=function(t){return typeof t=="number"?"number:"+wl(t):"string:"+t},Kl=function(t){if(t.isLeafNode()){const e=t.val();B(typeof e=="string"||typeof e=="number"||typeof e=="object"&&at(e,".sv"),"Priority must be a string or number.")}else B(t===di||t.isEmpty(),"priority of unexpected type.");B(t===di||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vr;class qe{constructor(e,n=qe.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,B(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),Kl(this.priorityNode_)}static set __childrenNodeConstructor(e){Vr=e}static get __childrenNodeConstructor(){return Vr}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new qe(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:qe.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return ue(e)?this:ce(e)===".priority"?this.priorityNode_:qe.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:qe.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const s=ce(e);return s===null?n:n.isEmpty()&&s!==".priority"?this:(B(s!==".priority"||kt(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(s,qe.__childrenNodeConstructor.EMPTY_NODE.updateChild(Se(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Yl(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=wl(this.value_):e+=this.value_,this.lazyHash_=yl(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===qe.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof qe.__childrenNodeConstructor?-1:(B(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,s=typeof this.value_,i=qe.VALUE_TYPE_ORDER.indexOf(n),r=qe.VALUE_TYPE_ORDER.indexOf(s);return B(i>=0,"Unknown leaf type: "+n),B(r>=0,"Unknown leaf type: "+s),i===r?s==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}qe.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kd=Math.log(2);class xd{constructor(e){const n=r=>parseInt(Math.log(r)/Kd,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const fs=function(t,e,n,s){t.sort(e);const i=function(l,u){const d=u-l;let c,f;if(d===0)return null;if(d===1)return c=t[l],f=n?n(c):c,new We(f,c.node,We.BLACK,null,null);{const h=parseInt(d/2,10)+l,_=i(l,h),y=i(h+1,u);return c=t[h],f=n?n(c):c,new We(f,c.node,We.BLACK,_,y)}},r=function(l){let u=null,d=null,c=t.length;const f=function(_,y){const w=c-_,v=c;c-=_;const N=i(w+1,v),C=t[w],T=n?n(C):C;h(new We(T,C.node,y,null,N))},h=function(_){u?(u.left=_,u=_):(d=_,u=_)};for(let _=0;_<l.count;++_){const y=l.nextBitIsOne(),w=Math.pow(2,l.count-(_+1));y?f(w,We.BLACK):(f(w,We.BLACK),f(w,We.RED))}return d},o=new xd(t.length),a=r(o);return new xe(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xs;const xt={};class ct{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return B(xt&&Oe,"ChildrenNode.ts has not been loaded"),xs=xs||new ct({".priority":xt},{".priority":Oe}),xs}get(e){const n=rn(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof xe?n:null}hasIndex(e){return at(this.indexSet_,e.toString())}addIndex(e,n){B(e!==yt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=n.getIterator(ae.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let a;i?a=fs(s,e.getCompare()):a=xt;const l=e.toString(),u=Object.assign({},this.indexSet_);u[l]=e;const d=Object.assign({},this.indexes_);return d[l]=a,new ct(d,u)}addToIndexes(e,n){const s=ls(this.indexes_,(i,r)=>{const o=rn(this.indexSet_,r);if(B(o,"Missing index implementation for "+r),i===xt)if(o.isDefinedOn(e.node)){const a=[],l=n.getIterator(ae.Wrap);let u=l.getNext();for(;u;)u.name!==e.name&&a.push(u),u=l.getNext();return a.push(e),fs(a,o.getCompare())}else return xt;else{const a=n.get(e.name);let l=i;return a&&(l=l.remove(new ae(e.name,a))),l.insert(e,e.node)}});return new ct(s,this.indexSet_)}removeFromIndexes(e,n){const s=ls(this.indexes_,i=>{if(i===xt)return i;{const r=n.get(e.name);return r?i.remove(new ae(e.name,r)):i}});return new ct(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xd=!0;function He(t,e=null){if(t===null)return re.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),B(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new qe(n,He(e))}if(!(t instanceof Array)&&Xd){const n=[];let s=!1;if(Xe(t,(o,a)=>{if(o.substring(0,1)!=="."){const l=He(a);l.isEmpty()||(s=s||!l.getPriority().isEmpty(),n.push(new ae(o,l)))}}),n.length===0)return re.EMPTY_NODE;const r=fs(n,Ud,o=>o.name,Wi);if(s){const o=fs(n,Oe.getCompare());return new re(r,He(e),new ct({".priority":o},{".priority":Oe}))}else return new re(r,He(e),ct.Default)}else{let n=re.EMPTY_NODE;return Xe(t,(s,i)=>{if(at(t,s)&&s.substring(0,1)!=="."){const r=He(i);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(s,r))}}),n.updatePriority(He(e))}}jd(He);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,"").replace(/^ /,"").slice(0,e)}function wi(t,e,n){(!t.maxLength||t.maxLength!=n)&&e.length>=n&&(t.maxLength=n)}function Ua(t,e){t={...t},e={...e};for(let n of vi)t[n]?t[n]=t[n].name:t[n]="";for(let n of Wn)e[n]?e[n]=e[n].name:e[n]="";return{eq:t,gear:e}}function fr(){window.history.replaceState(null,null,location.origin+location.pathname+"?ls=true")}function l_(t){let e,n,s,i,r,o,a,l;return{c(){e=g("li"),n=g("button"),s=g("img"),r=M(),o=g("span"),o.textContent=`${t[3]}`,Je(s.src,i=t[0].image)||m(s,"src",i),m(s,"alt",""),J(e,"selectedItem",t[2])},m(u,d){q(u,e,d),p(e,n),p(n,s),p(n,r),p(n,o),t[8](e),a||(l=[Yo(t[4].call(null,o)),D(n,"click",t[5])],a=!0)},p(u,[d]){d&1&&!Je(s.src,i=u[0].image)&&m(s,"src",i),d&4&&J(e,"selectedItem",u[2])},i:X,o:X,d(u){u&&L(e),t[8](null),a=!1,be(l)}}}function a_(t,e,n){let s,i,r,o;x(t,Xt,v=>n(9,s=v)),x(t,ft,v=>n(10,i=v)),x(t,Et,v=>n(11,r=v)),x(t,Di,v=>n(12,o=v));let{itemData:a,slotOpen:l,eqSlotName:u}=e;const d=Nt();let c,f=!1,h=a.name;function _(v){setTimeout(()=>{dr(c,h)&&o.push({node:c,itemName:h})})}function y(v){if(l||!l&&v.isTrusted==!1){d("itemSelect",{element:c,trusted:v.isTrusted}),c.classList.contains("selectedItem")||n(2,f=!1),n(2,f=!f),n(6,l=!1),U(ft,i[u]=f?a:ur,i),Ha(i,r);for(let N of Object.keys(yi)){U(Xt,s[N]=0,s);for(let C in i)U(Xt,s[N]+=i[C].stats[N],s),U(Xt,s[N]=Math.round(s[N]*10)/10,s)}}}function w(v){Z[v?"unshift":"push"](()=>{c=v,n(1,c)})}return t.$$set=v=>{"itemData"in v&&n(0,a=v.itemData),"slotOpen"in v&&n(6,l=v.slotOpen),"eqSlotName"in v&&n(7,u=v.eqSlotName)},[a,c,f,h,_,y,l,u,w]}class u_ extends Ne{constructor(e){super(),Te(this,e,a_,l_,de,{itemData:0,slotOpen:6,eqSlotName:7})}}function c_(t){let e,n,s,i,r,o,a,l,u;return{c(){e=g("li"),n=g("button"),s=g("img"),r=M(),o=g("span"),o.textContent=`${t[4]}`,Je(s.src,i=t[0].image)||m(s,"src",i),m(s,"alt",""),n.disabled=a=!t[3],J(e,"selectedItem",t[2]),J(e,"non-eligible",!t[3])},m(d,c){q(d,e,c),p(e,n),p(n,s),p(n,r),p(n,o),t[11](e),l||(u=[Yo(t[5].call(null,o)),D(n,"click",t[6])],l=!0)},p(d,[c]){c&1&&!Je(s.src,i=d[0].image)&&m(s,"src",i),c&8&&a!==(a=!d[3])&&(n.disabled=a),c&4&&J(e,"selectedItem",d[2]),c&8&&J(e,"non-eligible",!d[3])},i:X,o:X,d(d){d&&L(e),t[11](null),l=!1,be(u)}}}function d_(t,e,n){let s,i,r;x(t,Et,C=>n(10,s=C)),x(t,ft,C=>n(12,i=C)),x(t,Di,C=>n(13,r=C));let{itemData:o,slotOpen:a,index:l,weaponExpand:u}=e;const d=Nt();let c,f=!1,h=!0,_=o.name,y={"Orange Salamander":["Green Salamander","Purple Salamander"],"Green Salamander":["Orange Salamander","Purple Salamander"],"Purple Salamander":["Orange Salamander","Green Salamander"],"White Salamander":["Black Salamander","Gold Salamander"],"Black Salamander":["White Salamander","Gold Salamander"],"Gold Salamander":["White Salamander","Black Salamander"]};function w(C){setTimeout(()=>{dr(c,_)&&r.push({node:c,itemName:_})})}function v(C){h&&(a||!a&&C.isTrusted==!1)&&(d("itemSelect",{element:c,trusted:C.isTrusted}),c.classList.contains("selectedItem")||n(2,f=!1),n(2,f=!f),n(7,a=!1),U(Et,s[l]=f?o:cr,s),Ha(i,s))}function N(C){Z[C?"unshift":"push"](()=>{c=C,n(1,c)})}return t.$$set=C=>{"itemData"in C&&n(0,o=C.itemData),"slotOpen"in C&&n(7,a=C.slotOpen),"index"in C&&n(8,l=C.index),"weaponExpand"in C&&n(9,u=C.weaponExpand)},t.$$.update=()=>{if(t.$$.dirty&1793&&s)for(let C in s)if(C!=l&&(s[C].name==_||y[s[C].name]&&y[s[C].name].includes(_))){n(3,h=!1);break}else!u&&!o.tool&&n(3,h=!0);if(t.$$.dirty&1793){if(u)o.tool&&n(3,h=!1);else if(o.tool)for(let C in s)if(C!=l&&s[C].name==_){n(3,h=!1);break}else n(3,h=!0)}},[o,c,f,h,_,w,v,a,l,u,s,N]}class f_ extends Ne{constructor(e){super(),Te(this,e,d_,c_,de,{itemData:0,slotOpen:7,index:8,weaponExpand:9})}}function h_(t){const e=t-1;return e*e*e+1}function je(t,{delay:e=0,duration:n=400,easing:s=Ss}={}){const i=+getComputedStyle(t).opacity;return{delay:e,duration:n,easing:s,css:r=>`opacity: ${r*i}`}}function lt(t,{delay:e=0,duration:n=400,easing:s=h_,start:i=0,opacity:r=0}={}){const o=getComputedStyle(t),a=+o.opacity,l=o.transform==="none"?"":o.transform,u=1-i,d=a*(1-r);return{delay:e,duration:n,easing:s,css:(c,f)=>`
			transform: ${l} scale(${1-u*f});
			opacity: ${a-d*f}
		`}}function uo(t){let e,n,s,i;return{c(){e=g("img"),Je(e.src,n=t[5][t[3]])||m(e,"src",n),m(e,"alt","")},m(r,o){q(r,e,o),i=!0},p(r,o){(!i||o&8&&!Je(e.src,n=r[5][r[3]]))&&m(e,"src",n)},i(r){i||(r&&ye(()=>{i&&(s||(s=Re(e,je,{duration:150},!0)),s.run(1))}),i=!0)},o(r){r&&(s||(s=Re(e,je,{duration:150},!1)),s.run(0)),i=!1},d(r){r&&L(e),r&&s&&s.end()}}}function __(t){let e,n,s=t[5][t[3]],i,r,o=t[0].name+"",a,l,u,d=uo(t);return{c(){e=g("li"),n=g("button"),d.c(),i=M(),r=g("span"),a=se(o),J(e,"selectedItem",t[4])},m(c,f){q(c,e,f),p(e,n),d.m(n,null),p(n,i),p(n,r),p(r,a),t[8](e),l||(u=[D(n,"click",t[6]),D(e,"mouseenter",t[9]),D(e,"focusin",t[10]),D(e,"mouseleave",t[11]),D(e,"focusout",t[12])],l=!0)},p(c,[f]){f&8&&de(s,s=c[5][c[3]])?(Me(),G(d,1,1,X),Le(),d=uo(c),d.c(),H(d,1),d.m(n,i)):d.p(c,f),f&1&&o!==(o=c[0].name+"")&&ke(a,o)},i(c){H(d)},o(c){G(d)},d(c){c&&L(e),d.d(c),t[8](null),l=!1,be(u)}}}function p_(t,e,n){let s,i,r;x(t,Tn,I=>n(15,s=I)),x(t,ft,I=>n(16,i=I)),x(t,ei,I=>n(17,r=I));let{itemData:o,ddOpen:a=!1}=e,l,u=!1,d=!1,c,f=0,h=o.pieces.length,_=["head","body","legs","feet"];_=h==2?_.slice(1,3):h==3?_.slice(0,3):_;let y=[];for(let I=0;I<h;I++)y.push(r[_[I]].find(W=>W.name==o.pieces[I]).image);function w(){d?c=setInterval(()=>{n(3,f++,f),f==h&&n(3,f=0)},750):(clearInterval(c),n(3,f=0))}function v(){let I=0;for(let W=0;W<h;W++)!i[_[W]]||i[_[W]].name!=o.pieces[W]?s[_[W]][o.pieces[W]].querySelector("button").click():I++;I!=h&&n(7,a=!1)}function N(I){Z[I?"unshift":"push"](()=>{l=I,n(2,l)})}const C=()=>n(1,d=!0),T=()=>n(1,d=!0),S=()=>n(1,d=!1),P=()=>n(1,d=!1);return t.$$set=I=>{"itemData"in I&&n(0,o=I.itemData),"ddOpen"in I&&n(7,a=I.ddOpen)},t.$$.update=()=>{t.$$.dirty&2&&(d||!d)&&w()},[o,d,l,f,u,y,v,a,N,C,T,S,P]}class m_ extends Ne{constructor(e){super(),Te(this,e,p_,__,de,{itemData:0,ddOpen:7})}}function co(t,e,n){const s=t.slice();return s[36]=e[n],s}function g_(t){return{c:X,m:X,p:X,i:X,o:X,d:X}}function b_(t){let e,n,s,i,r,o,a=Ve(t[35]),l=[];for(let d=0;d<a.length;d+=1)l[d]=fo(co(t,a,d));const u=d=>G(l[d],1,1,()=>{l[d]=null});return{c(){e=g("input"),n=M(),s=g("ul");for(let d=0;d<l.length;d+=1)l[d].c();m(e,"type","text"),m(e,"class","searchBarInput"),m(e,"placeholder","Search..."),J(s,"no-scrollbar",t[8].length<=4)},m(d,c){q(d,e,c),t[19](e),q(d,n,c),q(d,s,c);for(let f=0;f<l.length;f+=1)l[f]&&l[f].m(s,null);t[24](s),i=!0,r||(o=[D(e,"keydown",t[11]),D(e,"input",t[12])],r=!0)},p(d,c){if(c[0]&9743){a=Ve(d[35]);let f;for(f=0;f<a.length;f+=1){const h=co(d,a,f);l[f]?(l[f].p(h,c),H(l[f],1)):(l[f]=fo(h),l[f].c(),H(l[f],1),l[f].m(s,null))}for(Me(),f=a.length;f<l.length;f+=1)u(f);Le()}(!i||c[0]&256)&&J(s,"no-scrollbar",d[8].length<=4)},i(d){if(!i){for(let c=0;c<a.length;c+=1)H(l[c]);i=!0}},o(d){l=l.filter(Boolean);for(let c=0;c<l.length;c+=1)G(l[c]);i=!1},d(d){d&&(L(e),L(n),L(s)),t[19](null),Ct(l,d),t[24](null),r=!1,be(o)}}}function y_(t){let e,n,s;function i(o){t[23](o)}let r={itemData:t[36],eqSlotName:t[2]};return t[0]!==void 0&&(r.slotOpen=t[0]),e=new u_({props:r}),Z.push(()=>we(e,"slotOpen",i)),e.$on("itemSelect",t[13]),{c(){me(e.$$.fragment)},m(o,a){_e(e,o,a),s=!0},p(o,a){const l={};a[0]&516&&(l.itemData=o[36]),a[0]&4&&(l.eqSlotName=o[2]),!n&&a[0]&1&&(n=!0,l.slotOpen=o[0],ve(()=>n=!1)),e.$set(l)},i(o){s||(H(e.$$.fragment,o),s=!0)},o(o){G(e.$$.fragment,o),s=!1},d(o){pe(e,o)}}}function v_(t){let e,n,s;function i(o){t[22](o)}let r={itemData:t[36]};return t[0]!==void 0&&(r.ddOpen=t[0]),e=new m_({props:r}),Z.push(()=>we(e,"ddOpen",i)),{c(){me(e.$$.fragment)},m(o,a){_e(e,o,a),s=!0},p(o,a){const l={};a[0]&516&&(l.itemData=o[36]),!n&&a[0]&1&&(n=!0,l.ddOpen=o[0],ve(()=>n=!1)),e.$set(l)},i(o){s||(H(e.$$.fragment,o),s=!0)},o(o){G(e.$$.fragment,o),s=!1},d(o){pe(e,o)}}}function w_(t){let e,n,s,i;function r(l){t[20](l)}function o(l){t[21](l)}let a={itemData:t[36],index:t[3]};return t[0]!==void 0&&(a.slotOpen=t[0]),t[1]!==void 0&&(a.weaponExpand=t[1]),e=new f_({props:a}),Z.push(()=>we(e,"slotOpen",r)),Z.push(()=>we(e,"weaponExpand",o)),e.$on("itemSelect",t[13]),{c(){me(e.$$.fragment)},m(l,u){_e(e,l,u),i=!0},p(l,u){const d={};u[0]&516&&(d.itemData=l[36]),u[0]&8&&(d.index=l[3]),!n&&u[0]&1&&(n=!0,d.slotOpen=l[0],ve(()=>n=!1)),!s&&u[0]&2&&(s=!0,d.weaponExpand=l[1],ve(()=>s=!1)),e.$set(d)},i(l){i||(H(e.$$.fragment,l),i=!0)},o(l){G(e.$$.fragment,l),i=!1},d(l){pe(e,l)}}}function fo(t){let e,n,s,i;const r=[w_,v_,y_],o=[];function a(l,u){return l[3]?0:l[2]=="builds"?1:2}return e=a(t),n=o[e]=r[e](t),{c(){n.c(),s=qt()},m(l,u){o[e].m(l,u),q(l,s,u),i=!0},p(l,u){let d=e;e=a(l),e===d?o[e].p(l,u):(Me(),G(o[d],1,1,()=>{o[d]=null}),Le(),n=o[e],n?n.p(l,u):(n=o[e]=r[e](l),n.c()),H(n,1),n.m(s.parentNode,s))},i(l){i||(H(n),i=!0)},o(l){G(n),i=!1},d(l){l&&L(s),o[e].d(l)}}}function C_(t){let e;return{c(){e=g("span"),e.textContent="Loading items...",m(e,"class","svelte-o6g1ik")},m(n,s){q(n,e,s)},p:X,i:X,o:X,d(n){n&&L(e)}}}function E_(t){let e,n,s,i,r,o={ctx:t,current:null,token:null,hasCatch:!1,pending:C_,then:b_,catch:g_,value:35,blocks:[,,,]};return mr(n=t[10]||t[9][t[2]],o),{c(){e=g("div"),o.block.c(),m(e,"class","dropdown svelte-o6g1ik")},m(a,l){q(a,e,l),o.block.m(e,o.anchor=null),o.mount=()=>e,o.anchor=null,s=!0,i||(r=[D(e,"transitionend",t[25]),D(e,"transitioncancel",t[26])],i=!0)},p(a,l){t=a,o.ctx=t,l[0]&516&&n!==(n=t[10]||t[9][t[2]])&&mr(n,o)||au(o,t,l)},i(a){s||(H(o.block),s=!0)},o(a){for(let l=0;l<3;l+=1){const u=o.blocks[l];G(u)}s=!1},d(a){a&&L(e),o.block.d(),o.token=null,o=null,i=!1,be(r)}}}function S_(t,e,n){let s,i,r,o,a;x(t,Tn,b=>n(16,i=b)),x(t,du,b=>n(17,r=b)),x(t,rs,b=>n(18,o=b)),x(t,ei,b=>n(9,a=b));let{slotName:l,index:u,slotOpen:d,weaponExpand:c}=e;const f=Nt();u?U(rs,o[u]={},o):U(Tn,i[l]={},i);let h,_,y,w=null,v=!1,N=`https://raw.githubusercontent.com/XT8SS/fc-sv/gh-pages/ff-data/${l}.json`,C=a[l]||null,T=!1,S=[];const P=a[l]?null:fetch(N).then(async b=>{if(b.status!=200){console.error(`Failed to fetch ${(u?"weapon #":"")+l} slot data from ${N}
...
${b}`)});function I(){y&&y.classList.remove("lastElement"),n(8,S=_.querySelectorAll("li:not(.hidden)")),y=S[S.length-1],y&&y.classList.add("lastElement"),(!y||y.classList.contains("non-eligible"))&&(y=h)}function W(b){!b.shiftKey&&b.key=="Tab"&&(b.preventDefault(),setTimeout(()=>h.focus()))}function ie(){y&&y.removeEventListener("keydown",W),I(),y&&y.addEventListener("keydown",W)}function A(b){b.shiftKey&&b.key=="Tab"&&(b.preventDefault(),setTimeout(()=>(y.querySelector("button")||y).focus()))}function F(){za(h.value,s),ie()}function R(b){f("itemSelect",b.detail.element),n(6,w=b.detail.element),v=b.detail.trusted;let O=_.querySelector(".selectedItem");O&&O!=b.detail.element&&O.classList.remove("selectedItem"),n(7,T=!0),v||(v=!1,K(),_.scrollTo(0,w.offsetTop))}function K(){n(7,T=!1),n(5,h.value="",h),F()}function Q(b){Z[b?"unshift":"push"](()=>{h=b,n(5,h)})}function k(b){d=b,n(0,d)}function Y(b){c=b,n(1,c)}function ee(b){d=b,n(0,d)}function j(b){d=b,n(0,d)}function te(b){Z[b?"unshift":"push"](()=>{_=b,n(4,_)})}const fe=b=>{b.propertyName=="visibility"&&(T&&K(),!d&&w&&_.scrollTo(0,w.offsetTop),Cs(h,d))},z=b=>{b.propertyName=="visibility"&&(n(7,T=!1),Cs(h,d))};return t.$$set=b=>{"slotName"in b&&n(2,l=b.slotName),"index"in b&&n(3,u=b.index),"slotOpen"in b&&n(0,d=b.slotOpen),"weaponExpand"in b&&n(1,c=b.weaponExpand)},t.$$.update=()=>{if(t.$$.dirty[0]&458764&&(s=u?o[u]:l=="builds"?r:i[l]),t.$$.dirty[0]&32784&&_){n(8,S=_.querySelectorAll("li:not(.hidden)"));for(let b=0;b<_.childElementCount;b++)s[C[b].name]=_.children[b];I(),ie()}},[d,c,l,u,_,h,w,T,S,a,P,A,F,R,K,C,i,r,o,Q,k,Y,ee,j,te,fe,z]}class hr extends Ne{constructor(e){super(),Te(this,e,S_,E_,de,{slotName:2,index:3,slotOpen:0,weaponExpand:1},null,[-1,-1])}}function ho(t){let e,n,s,i,r,o,a=t[1].name+"",l,u,d,c,f,h;return{c(){e=g("a"),n=g("img"),r=M(),o=g("span"),l=se(a),Je(n.src,s=t[1].image)||m(n,"src",s),m(n,"alt",i=t[1].name),m(n,"draggable","false"),m(n,"class","svelte-1j6yuis"),m(o,"class","tooltip"),m(o,"id","left"),m(e,"href",u=t[1].link),m(e,"target","_blank"),m(e,"class","svelte-1j6yuis"),De(e,"display",t[1].link?"":"none")},m(_,y){q(_,e,y),p(e,n),p(e,r),p(e,o),p(o,l),c=!0,f||(h=[D(e,"focusin",t[11]),D(e,"outroend",t[12])],f=!0)},p(_,y){(!c||y&2&&!Je(n.src,s=_[1].image))&&m(n,"src",s),(!c||y&2&&i!==(i=_[1].name))&&m(n,"alt",i),(!c||y&2)&&a!==(a=_[1].name+"")&&ke(l,a),(!c||y&2&&u!==(u=_[1].link))&&m(e,"href",u),y&2&&De(e,"display",_[1].link?"":"none")},i(_){c||(_&&ye(()=>{c&&(d||(d=Re(e,je,{duration:150},!0)),d.run(1))}),c=!0)},o(_){_&&(d||(d=Re(e,je,{duration:150},!1)),d.run(0)),c=!1},d(_){_&&L(e),_&&d&&d.end(),f=!1,be(h)}}}function k_(t){let e,n,s=t[1],i,r,o,a=t[0].charAt(0).toUpperCase()+t[0].slice(1)+"",l,u,d,c,f,h,_,y,w,v,N,C=ho(t);function T(P){t[17](P)}let S={slotName:t[0],index:null,weaponExpand:null};return t[5]!==void 0&&(S.slotOpen=t[5]),_=new hr({props:S}),Z.push(()=>we(_,"slotOpen",T)),_.$on("itemSelect",t[18]),{c(){e=g("div"),n=g("div"),C.c(),r=M(),o=g("button"),l=se(a),u=M(),d=g("iconify-icon"),c=M(),f=g("button"),f.innerHTML='<iconify-icon icon="maki:cross" class="svelte-1j6yuis"></iconify-icon> <span class="tooltip" id="top">Clear selection</span>',h=M(),me(_.$$.fragment),m(n,"class","eqSlotIcon ff-border svelte-1j6yuis"),ye(()=>t[14].call(n)),De(n,"min-width",`${t[4]}px`),Wt(d,"icon","iconamoon:arrow-down-2-fill"),Wt(d,"class","svelte-1j6yuis"),m(o,"class","ddButton svelte-1j6yuis"),m(f,"class","clearButton svelte-1j6yuis"),m(e,"class","eqSlotCont svelte-1j6yuis"),J(e,"slotOpen",t[5]),J(e,"clearAllowed",t[6]&&t[7])},m(P,I){q(P,e,I),p(e,n),C.m(n,null),t[13](n),i=rt(n,t[14].bind(n)),p(e,r),p(e,o),p(o,l),p(o,u),p(o,d),p(e,c),p(e,f),p(e,h),_e(_,e,null),t[19](e),w=!0,v||(N=[D(window,"mousedown",t[9]),D(window,"keydown",t[10]),D(o,"click",t[15]),D(f,"click",t[16]),D(e,"keydown",t[20]),D(e,"mouseenter",t[21]),D(e,"mouseleave",t[22])],v=!0)},p(P,[I]){I&2&&de(s,s=P[1])?(Me(),G(C,1,1,X),Le(),C=ho(P),C.c(),H(C,1),C.m(n,null)):C.p(P,I),I&16&&De(n,"min-width",`${P[4]}px`),(!w||I&1)&&a!==(a=P[0].charAt(0).toUpperCase()+P[0].slice(1)+"")&&ke(l,a);const W={};I&1&&(W.slotName=P[0]),!y&&I&32&&(y=!0,W.slotOpen=P[5],ve(()=>y=!1)),_.$set(W),(!w||I&32)&&J(e,"slotOpen",P[5]),(!w||I&192)&&J(e,"clearAllowed",P[6]&&P[7])},i(P){w||(H(C),H(_.$$.fragment,P),w=!0)},o(P){G(C),G(_.$$.fragment,P),w=!1},d(P){P&&L(e),C.d(P),t[13](null),i(),pe(_),t[19](null),v=!1,be(N)}}}function I_(t,e,n){let s;x(t,ft,A=>n(8,s=A));let{eqSlotName:i}=e,r,o,a,l=ur,u,d,c;const f=A=>{(!r.contains(A.target)||A.target==r||A.target==o)&&(n(5,u=!1),A.target!=r&&A.target!=o&&n(6,d=!1))},h=A=>{A.key=="Tab"&&setTimeout(()=>{n(6,d=r.contains(document.activeElement))})},_=A=>{A.relatedTarget==null&&n(6,d=!0)},y=()=>{setTimeout(()=>{r_(o)})};function w(A){Z[A?"unshift":"push"](()=>{o=A,n(3,o)})}function v(){a=this.offsetHeight,n(4,a)}const N=()=>n(5,u=!u),C=()=>{n(6,d=!1),r.classList.contains("clearAllowed")&&c.querySelector("button").click()};function T(A){u=A,n(5,u)}const S=A=>{setTimeout(()=>{n(7,c=A.detail.classList.contains("selectedItem")?A.detail:null)})};function P(A){Z[A?"unshift":"push"](()=>{r=A,n(2,r)})}const I=A=>{A.key=="Escape"&&n(5,u=!1)},W=()=>n(6,d=!0),ie=()=>{r.contains(document.activeElement)||n(6,d=!1)};return t.$$set=A=>{"eqSlotName"in A&&n(0,i=A.eqSlotName)},t.$$.update=()=>{t.$$.dirty&259&&s[i]&&s[i].name!=l.name&&n(1,l=s[i])},[i,l,r,o,a,u,d,c,s,f,h,_,y,w,v,N,C,T,S,P,I,W,ie]}class T_ extends Ne{constructor(e){super(),Te(this,e,I_,k_,de,{eqSlotName:0})}}function _o(t,e,n){const s=t.slice();return s[1]=e[n],s[2]=e,s[3]=n,s}function po(t){let e,n,s;function i(o){t[0](o,t[1],t[2],t[3])}let r={};return t[1]!==void 0&&(r.eqSlotName=t[1]),e=new T_({props:r}),Z.push(()=>we(e,"eqSlotName",i)),{c(){me(e.$$.fragment)},m(o,a){_e(e,o,a),s=!0},p(o,a){t=o;const l={};!n&&a&0&&(n=!0,l.eqSlotName=t[1],ve(()=>n=!1)),e.$set(l)},i(o){s||(H(e.$$.fragment,o),s=!0)},o(o){G(e.$$.fragment,o),s=!1},d(o){pe(e,o)}}}function N_(t){let e,n,s=Ve(Array(...vi)),i=[];for(let o=0;o<s.length;o+=1)i[o]=po(_o(t,s,o));const r=o=>G(i[o],1,1,()=>{i[o]=null});return{c(){e=g("div");for(let o=0;o<i.length;o+=1)i[o].c();m(e,"class","armorBox svelte-3p4tb9")},m(o,a){q(o,e,a);for(let l=0;l<i.length;l+=1)i[l]&&i[l].m(e,null);n=!0},p(o,[a]){if(a&0){s=Ve(Array(...vi));let l;for(l=0;l<s.length;l+=1){const u=_o(o,s,l);i[l]?(i[l].p(u,a),H(i[l],1)):(i[l]=po(u),i[l].c(),H(i[l],1),i[l].m(e,null))}for(Me(),l=s.length;l<i.length;l+=1)r(l);Le()}},i(o){if(!n){for(let a=0;a<s.length;a+=1)H(i[a]);n=!0}},o(o){i=i.filter(Boolean);for(let a=0;a<i.length;a+=1)G(i[a]);n=!1},d(o){o&&L(e),Ct(i,o)}}}function D_(t,e,n){function s(i,r,o,a){o[a]=i}return[s]}class O_ extends Ne{constructor(e){super(),Te(this,e,D_,N_,de,{})}}function R_(t){let e,n=(t[5]?`${Math.floor(t[2][t[0]]*.675+19.8)}% Reduction`:t[6])+"",s,i,r,o;return{c(){e=g("span"),s=se(n),m(e,"class","statValue svelte-16tz2kw"),m(e,"tabindex","0"),m(e,"style",i=t[5]?`font-size: ${t[3]*.7/6.85}px;`:""),J(e,"hidden",t[4]),J(e,"negative",t[6]<0),J(e,"reduction",t[5])},m(a,l){q(a,e,l),p(e,s),r||(o=[D(e,"mouseenter",t[10]),D(e,"mouseleave",t[11]),D(e,"focusin",t[12]),D(e,"focusout",t[13])],r=!0)},p(a,l){l&101&&n!==(n=(a[5]?`${Math.floor(a[2][a[0]]*.675+19.8)}% Reduction`:a[6])+"")&&ke(s,n),l&40&&i!==(i=a[5]?`font-size: ${a[3]*.7/6.85}px;`:"")&&m(e,"style",i),l&16&&J(e,"hidden",a[4]),l&64&&J(e,"negative",a[6]<0),l&32&&J(e,"reduction",a[5])},d(a){a&&L(e),r=!1,be(o)}}}function A_(t){let e,n=(t[0]!="endurance"?t[6]:t[6].toFixed(2))+"",s;return{c(){e=g("span"),s=se(n),m(e,"class","statValue svelte-16tz2kw"),J(e,"hidden",t[4]),J(e,"negative",t[6]<0)},m(i,r){q(i,e,r),p(e,s)},p(i,r){r&65&&n!==(n=(i[0]!="endurance"?i[6]:i[6].toFixed(2))+"")&&ke(s,n),r&16&&J(e,"hidden",i[4]),r&64&&J(e,"negative",i[6]<0)},d(i){i&&L(e)}}}function mo(t){let e,n=`${t[1]} Bonus`,s;return{c(){e=g("span"),s=se(n),De(e,"font-size",`${t[3]*.7/t[7][t[0]]}px`)},m(i,r){q(i,e,r),p(e,s)},p(i,r){r&2&&n!==(n=`${i[1]} Bonus`)&&ke(s,n),r&9&&De(e,"font-size",`${i[3]*.7/i[7][i[0]]}px`)},d(i){i&&L(e)}}}function P_(t){let e,n,s,i,r,o,a,l;function u(h,_){return h[0]!="armor"?A_:R_}let d=u(t),c=d(t),f=t[4]&&mo(t);return{c(){e=g("div"),n=g("img"),i=M(),c.c(),r=M(),f&&f.c(),Je(n.src,s="stats/"+t[0]+".svg")||m(n,"src",s),m(n,"alt",t[1]),m(n,"class","svelte-16tz2kw"),m(e,"id",t[0]),m(e,"class","svelte-16tz2kw"),ye(()=>t[14].call(e)),J(e,"hidden",t[6]==0)},m(h,_){q(h,e,_),p(e,n),p(e,i),c.m(e,null),p(e,r),f&&f.m(e,null),o=rt(e,t[14].bind(e)),a||(l=[D(n,"mouseenter",t[8]),D(n,"mouseleave",t[9])],a=!0)},p(h,[_]){_&1&&!Je(n.src,s="stats/"+h[0]+".svg")&&m(n,"src",s),_&2&&m(n,"alt",h[1]),d===(d=u(h))&&c?c.p(h,_):(c.d(1),c=d(h),c&&(c.c(),c.m(e,r))),h[4]?f?f.p(h,_):(f=mo(h),f.c(),f.m(e,null)):f&&(f.d(1),f=null),_&1&&m(e,"id",h[0]),_&64&&J(e,"hidden",h[6]==0)},i:X,o:X,d(h){h&&L(e),c.d(),f&&f.d(),o(),a=!1,be(l)}}}function M_(t,e,n){let s,i;x(t,Xt,N=>n(2,i=N));let{codeName:r,formalName:o}=e,a,l,u,d={armor:5.9,magicDmg:5.65,meleeDmg:5.7,rangedDmg:6.45,hpRegen:7.35,endurance:7.85,sightRange:8.45,walkSpeed:8.3,jumpPower:8.7,ammoReturn:9.3,height:6.1};const c=()=>n(4,l=!0),f=()=>n(4,l=!1),h=()=>n(5,u=!0),_=()=>n(5,u=!1),y=()=>n(5,u=!0),w=()=>n(5,u=!1);function v(){a=this.offsetWidth,n(3,a)}return t.$$set=N=>{"codeName"in N&&n(0,r=N.codeName),"formalName"in N&&n(1,o=N.formalName)},t.$$.update=()=>{t.$$.dirty&5&&n(6,s=i[r]||0)},[r,o,i,a,l,u,s,d,c,f,h,_,y,w,v]}class L_ extends Ne{constructor(e){super(),Te(this,e,M_,P_,de,{codeName:0,formalName:1})}}function go(t,e,n){const s=t.slice();return s[2]=e[n][0],s[3]=e[n][1],s[4]=e,s[5]=n,s}function bo(t){let e,n,s,i;function r(l){t[0](l,t[2],t[4],t[5])}function o(l){t[1](l,t[3],t[4],t[5])}let a={};return t[2]!==void 0&&(a.codeName=t[2]),t[3]!==void 0&&(a.formalName=t[3]),e=new L_({props:a}),Z.push(()=>we(e,"codeName",r)),Z.push(()=>we(e,"formalName",o)),{c(){me(e.$$.fragment)},m(l,u){_e(e,l,u),i=!0},p(l,u){t=l;const d={};!n&&u&0&&(n=!0,d.codeName=t[2],ve(()=>n=!1)),!s&&u&0&&(s=!0,d.formalName=t[3],ve(()=>s=!1)),e.$set(d)},i(l){i||(H(e.$$.fragment,l),i=!0)},o(l){G(e.$$.fragment,l),i=!1},d(l){pe(e,l)}}}function B_(t){let e,n,s=Ve(Object.entries(yi)),i=[];for(let o=0;o<s.length;o+=1)i[o]=bo(go(t,s,o));const r=o=>G(i[o],1,1,()=>{i[o]=null});return{c(){e=g("div");for(let o=0;o<i.length;o+=1)i[o].c();m(e,"class","statBox svelte-lu37w6")},m(o,a){q(o,e,a);for(let l=0;l<i.length;l+=1)i[l]&&i[l].m(e,null);n=!0},p(o,[a]){if(a&0){s=Ve(Object.entries(yi));let l;for(l=0;l<s.length;l+=1){const u=go(o,s,l);i[l]?(i[l].p(u,a),H(i[l],1)):(i[l]=bo(u),i[l].c(),H(i[l],1),i[l].m(e,null))}for(Me(),l=s.length;l<i.length;l+=1)r(l);Le()}},i(o){if(!n){for(let a=0;a<s.length;a+=1)H(i[a]);n=!0}},o(o){i=i.filter(Boolean);for(let a=0;a<i.length;a+=1)G(i[a]);n=!1},d(o){o&&L(e),Ct(i,o)}}}function F_(t,e,n){function s(r,o,a,l){a[l][0]=r}function i(r,o,a,l){a[l][1]=r}return[s,i]}class q_ extends Ne{constructor(e){super(),Te(this,e,F_,B_,de,{})}}function W_(t){let e,n,s,i,r,o,a,l,u,d;return{c(){e=g("div"),n=g("button"),n.textContent="-",s=M(),i=g("input"),r=M(),o=g("b"),o.textContent="%",a=M(),l=g("button"),l.textContent="+",m(n,"id","decrease"),m(n,"class","svelte-1d7zneu"),m(i,"type","number"),m(i,"placeholder","0"),m(i,"class","svelte-1d7zneu"),m(o,"class","svelte-1d7zneu"),m(l,"id","increase"),m(l,"class","svelte-1d7zneu"),m(e,"class","svelte-1d7zneu"),J(e,"non-percent",!t[1])},m(c,f){q(c,e,f),p(e,n),p(e,s),p(e,i),st(i,t[0]),p(e,r),p(e,o),p(e,a),p(e,l),u||(d=[D(n,"click",t[4]),D(i,"input",t[5]),D(i,"input",t[2]),D(l,"click",t[6])],u=!0)},p(c,[f]){f&1&&Xo(i.value)!==c[0]&&st(i,c[0])},i:X,o:X,d(c){c&&L(e),u=!1,be(d)}}}function H_(t,e,n){let{weaponName:s,value:i}=e,r=s!="Nature's Wrath Spellbook",o;r?(i=100,o=100):(i=4,o=4);function a(){i<0?n(0,i=0):i>o&&n(0,i=o),i%1!=0&&n(0,i=Math.floor(i))}const l=()=>{n(0,i--,i),a()};function u(){i=Xo(this.value),n(0,i)}const d=()=>{n(0,i++,i),a()};return t.$$set=c=>{"weaponName"in c&&n(3,s=c.weaponName),"value"in c&&n(0,i=c.value)},[i,r,a,s,l,u,d]}class z_ extends Ne{constructor(e){super(),Te(this,e,H_,W_,de,{weaponName:3,value:0})}}function U_(t){let e,n,s,i,r,o,a,l;return{c(){e=g("div"),n=g("span"),s=M(),i=g("input"),r=M(),o=g("iconify-icon"),m(i,"type","checkbox"),m(i,"class","svelte-na6yc3"),Wt(o,"icon","mingcute:check-fill"),Wt(o,"class","svelte-na6yc3"),m(e,"class","toggleCont svelte-na6yc3")},m(u,d){q(u,e,d),p(e,n),n.innerHTML=t[0],p(e,s),p(e,i),p(e,r),p(e,o),a||(l=[D(i,"change",t[2]),D(i,"keydown",t[3])],a=!0)},p(u,[d]){d&1&&(n.innerHTML=u[0])},i:X,o:X,d(u){u&&L(e),a=!1,be(l)}}}function V_(t,e,n){let{text:s}=e;const i=Nt(),r=a=>i("toggle",a.target.checked),o=a=>{a.key=="Enter"&&(a.target.checked=!a.target.checked,i("toggle",a.target.checked))};return t.$$set=a=>{"text"in a&&n(0,s=a.text)},[s,i,r,o]}class Va extends Ne{constructor(e){super(),Te(this,e,V_,U_,de,{text:0})}}function yo(t,e,n){const s=t.slice();s[40]=e[n];const i=s[40].name.includes("Fantastic Beamstorm")?"~":"";s[17]=i;const r=s[40].name.includes("Charged");return s[41]=r,s}function j_(t){let e,n,s=t[2].description+"",i,r;return{c(){e=g("span"),n=se('"'),i=se(s),r=se('"'),m(e,"id","toolDesc"),m(e,"class","svelte-1gfuxic")},m(o,a){q(o,e,a),p(e,n),p(e,i),p(e,r)},p(o,a){a[0]&4&&s!==(s=o[2].description+"")&&ke(i,s)},d(o){o&&L(e)}}}function G_(t){let e,n,s,i=`${t[13]?"Type":t[11].name}:`,r,o,a=t[15],l,u,d,c,f,h=t[13]?"Return":"Expand",_,y,w,v,N=vo(t),C=t[3]&&wo(t);return{c(){e=g("button"),n=g("div"),s=g("span"),r=se(i),o=M(),N.c(),u=M(),C&&C.c(),d=M(),c=g("span"),f=se("("),_=se(h),y=se(")"),m(s,"class","svelte-1gfuxic"),De(s,"font-size",Object.keys(t[16]).includes(t[11].name)?`calc(var(--u) * ${t[16][t[11].name]})`:""),m(n,"id",l=t[13]?"":"basic"),m(n,"class","svelte-1gfuxic"),m(c,"class","tooltip svelte-1gfuxic"),m(c,"id","top"),m(e,"class","gearPreview svelte-1gfuxic"),De(e,"line-height",`${t[7]/6.5}px`)},m(T,S){q(T,e,S),p(e,n),p(n,s),p(s,r),p(n,o),N.m(n,null),p(e,u),C&&C.m(e,null),p(e,d),p(e,c),p(c,f),p(c,_),p(c,y),t[28](e),w||(v=D(e,"click",t[21]),w=!0)},p(T,S){S[0]&10240&&i!==(i=`${T[13]?"Type":T[11].name}:`)&&ke(r,i),S[0]&67584&&De(s,"font-size",Object.keys(T[16]).includes(T[11].name)?`calc(var(--u) * ${T[16][T[11].name]})`:""),S[0]&32768&&de(a,a=T[15])?(N.d(1),N=vo(T),N.c(),N.m(n,null)):N.p(T,S),S[0]&8192&&l!==(l=T[13]?"":"basic")&&m(n,"id",l),T[3]?C?C.p(T,S):(C=wo(T),C.c(),C.m(e,d)):C&&(C.d(1),C=null),S[0]&8192&&h!==(h=T[13]?"Return":"Expand")&&ke(_,h),S[0]&128&&De(e,"line-height",`${T[7]/6.5}px`)},d(T){T&&L(e),N.d(T),C&&C.d(),t[28](null),w=!1,v()}}}function vo(t){let e,n=(t[13]?t[2].info.type.replace("/","<b>,</b><br/>"):t[19](t[11]))+"";return{c(){e=g("span"),m(e,"class","svelte-1gfuxic")},m(s,i){q(s,e,i),e.innerHTML=n},p(s,i){i[0]&10244&&n!==(n=(s[13]?s[2].info.type.replace("/","<b>,</b><br/>"):s[19](s[11]))+"")&&(e.innerHTML=n)},d(s){s&&L(e)}}}function wo(t){let e,n,s=`${t[13]?"Special":t[3].name.split(" (")[0]}:`,i,r,o=t[15],a,l=Co(t);return{c(){e=g("div"),n=g("span"),i=se(s),r=M(),l.c(),m(n,"class","svelte-1gfuxic"),De(n,"font-size",Object.keys(t[16]).includes(t[3].name)?`calc(var(--u) * ${t[16][t[3].name]})`:""),m(e,"id",a=t[13]?"":"special"),m(e,"class","svelte-1gfuxic")},m(u,d){q(u,e,d),p(e,n),p(n,i),p(e,r),l.m(e,null)},p(u,d){d[0]&8200&&s!==(s=`${u[13]?"Special":u[3].name.split(" (")[0]}:`)&&ke(i,s),d[0]&65544&&De(n,"font-size",Object.keys(u[16]).includes(u[3].name)?`calc(var(--u) * ${u[16][u[3].name]})`:""),d[0]&32768&&de(o,o=u[15])?(l.d(1),l=Co(u),l.c(),l.m(e,null)):l.p(u,d),d[0]&8192&&a!==(a=u[13]?"":"special")&&m(e,"id",a)},d(u){u&&L(e),l.d(u)}}}function Co(t){let e,n=(t[13]?t[2].info.special:t[17]+t[19](t[3]))+"",s;return{c(){e=g("span"),s=se(n),m(e,"class","svelte-1gfuxic")},m(i,r){q(i,e,r),p(e,s)},p(i,r){r[0]&139276&&n!==(n=(i[13]?i[2].info.special:i[17]+i[19](i[3]))+"")&&ke(s,n)},d(i){i&&L(e)}}}function Eo(t){let e,n,s,i,r,o,a=t[2].name+"",l,u,d,c;return{c(){e=g("a"),n=g("img"),r=M(),o=g("span"),l=se(a),Je(n.src,s=t[2].image)||m(n,"src",s),m(n,"alt",i=t[2].name),m(n,"draggable","false"),m(n,"class","svelte-1gfuxic"),m(o,"class","tooltip"),m(o,"id","right"),m(e,"href",u=t[2].link),m(e,"target","_blank"),m(e,"class","svelte-1gfuxic"),De(e,"display",t[2].link?"":"none"),De(e,"border-radius",t[2].tool?"calc(var(--u))":"")},m(f,h){q(f,e,h),p(e,n),p(e,r),p(e,o),p(o,l),c=!0},p(f,h){(!c||h[0]&4&&!Je(n.src,s=f[2].image))&&m(n,"src",s),(!c||h[0]&4&&i!==(i=f[2].name))&&m(n,"alt",i),(!c||h[0]&4)&&a!==(a=f[2].name+"")&&ke(l,a),(!c||h[0]&4&&u!==(u=f[2].link))&&m(e,"href",u),h[0]&4&&De(e,"display",f[2].link?"":"none"),h[0]&4&&De(e,"border-radius",f[2].tool?"calc(var(--u))":"")},i(f){c||(f&&ye(()=>{c&&(d||(d=Re(e,je,{duration:150},!0)),d.run(1))}),c=!0)},o(f){f&&(d||(d=Re(e,je,{duration:150},!1)),d.run(0)),c=!1},d(f){f&&L(e),f&&d&&d.end()}}}function So(t){let e,n,s,i,r,o,a;n=new Va({props:{text:"Toggle base values"}}),n.$on("toggle",t[36]);let l=Ve(t[2].moves),u=[];for(let c=0;c<l.length;c+=1)u[c]=To(yo(t,l,c));const d=c=>G(u[c],1,1,()=>{u[c]=null});return{c(){e=g("div"),me(n.$$.fragment),s=M(),i=g("div");for(let c=0;c<u.length;c+=1)u[c].c();m(i,"class","weaponMoves svelte-1gfuxic"),m(e,"class","fullWeaponView svelte-1gfuxic")},m(c,f){q(c,e,f),_e(n,e,null),p(e,s),p(e,i);for(let h=0;h<u.length;h+=1)u[h]&&u[h].m(i,null);a=!0},p(c,f){if(f[0]&1622036){l=Ve(c[2].moves);let h;for(h=0;h<l.length;h+=1){const _=yo(c,l,h);u[h]?(u[h].p(_,f),H(u[h],1)):(u[h]=To(_),u[h].c(),H(u[h],1),u[h].m(i,null))}for(Me(),h=l.length;h<u.length;h+=1)d(h);Le()}},i(c){if(!a){H(n.$$.fragment,c);for(let f=0;f<l.length;f+=1)H(u[f]);c&&ye(()=>{a&&(o&&o.end(1),r=Zo(e,je,{duration:150,delay:300}),r.start())}),a=!0}},o(c){G(n.$$.fragment,c),u=u.filter(Boolean);for(let f=0;f<u.length;f+=1)G(u[f]);r&&r.invalidate(),c&&(o=$o(e,je,{duration:150})),a=!1},d(c){c&&L(e),pe(n),Ct(u,c),c&&o&&o.end()}}}function ko(t){let e,n,s,i;function r(l){t[37](l)}function o(l){t[38](l)}let a={};return t[4]!==void 0&&(a.value=t[4]),t[2].name!==void 0&&(a.weaponName=t[2].name),e=new z_({props:a}),Z.push(()=>we(e,"value",r)),Z.push(()=>we(e,"weaponName",o)),{c(){me(e.$$.fragment)},m(l,u){_e(e,l,u),i=!0},p(l,u){const d={};!n&&u[0]&16&&(n=!0,d.value=l[4],ve(()=>n=!1)),!s&&u[0]&4&&(s=!0,d.weaponName=l[2].name,ve(()=>s=!1)),e.$set(d)},i(l){i||(H(e.$$.fragment,l),i=!0)},o(l){G(e.$$.fragment,l),i=!1},d(l){pe(e,l)}}}function Io(t){let e,n=t[17]+(t[14]&&!t[41]?t[40].base:t[41]?t[20](t[40]):t[19](t[40]))+"",s;return{c(){e=g("span"),s=se(n),m(e,"class","svelte-1gfuxic")},m(i,r){q(i,e,r),p(e,s)},p(i,r){r[0]&16388&&n!==(n=i[17]+(i[14]&&!i[41]?i[40].base:i[41]?i[20](i[40]):i[19](i[40]))+"")&&ke(s,n)},d(i){i&&L(e)}}}function To(t){let e,n,s,i,r=(t[41]&&t[2].name=="Nature's Wrath Spellbook"?t[40].name.replace("Charged","Charge(s)"):t[40].name)+":",o,a,l=t[41]?[t[15],t[4]]:t[15],u,d,c=t[41]&&ko(t),f=Io(t);return{c(){e=g("div"),n=g("div"),s=g("span"),c&&c.c(),i=M(),o=se(r),a=M(),f.c(),u=M(),m(s,"class","svelte-1gfuxic"),m(n,"class","ff-border svelte-1gfuxic"),m(e,"class","svelte-1gfuxic")},m(h,_){q(h,e,_),p(e,n),p(n,s),c&&c.m(s,null),p(s,i),p(s,o),p(n,a),f.m(n,null),p(e,u),d=!0},p(h,_){h[41]?c?(c.p(h,_),_[0]&4&&H(c,1)):(c=ko(h),c.c(),H(c,1),c.m(s,i)):c&&(Me(),G(c,1,1,()=>{c=null}),Le()),(!d||_[0]&4)&&r!==(r=(h[41]&&h[2].name=="Nature's Wrath Spellbook"?h[40].name.replace("Charged","Charge(s)"):h[40].name)+":")&&ke(o,r),_[0]&32788&&de(l,l=h[41]?[h[15],h[4]]:h[15])?(f.d(1),f=Io(h),f.c(),f.m(n,null)):f.p(h,_)},i(h){d||(H(c),d=!0)},o(h){G(c),d=!1},d(h){h&&L(e),c&&c.d(),f.d(h)}}}function Y_(t){let e,n,s,i,r,o,a=t[2],l,u,d,c,f,h,_,y,w,v,N;function C(F,R){if(F[2].name&&!F[2].tool)return G_;if(F[2].tool)return j_}let T=C(t),S=T&&T(t),P=Eo(t);function I(F){t[32](F)}function W(F){t[33](F)}let ie={slotName:t[0],index:t[1]};t[12]!==void 0&&(ie.slotOpen=t[12]),t[13]!==void 0&&(ie.weaponExpand=t[13]),c=new hr({props:ie}),Z.push(()=>we(c,"slotOpen",I)),Z.push(()=>we(c,"weaponExpand",W)),c.$on("itemSelect",t[34]);let A=t[13]&&So(t);return{c(){e=g("div"),n=g("button"),n.innerHTML=`<iconify-icon icon="iconamoon:arrow-down-2-fill" rotate="90deg" class="svelte-1gfuxic"></iconify-icon>
        Gear`,s=M(),i=g("div"),S&&S.c(),r=M(),o=g("div"),P.c(),d=M(),me(c.$$.fragment),_=M(),A&&A.c(),y=qt(),m(n,"class","ddButton svelte-1gfuxic"),m(o,"class","gearSlotIcon svelte-1gfuxic"),ye(()=>t[29].call(o)),De(o,"min-width",`${t[8]}px`),m(i,"class","gearInfoCont ff-border svelte-1gfuxic"),ye(()=>t[31].call(i)),De(i,"justify-content",t[2].name?"":"flex-end"),m(e,"class","gearSlot svelte-1gfuxic"),J(e,"slotOpen",t[12]),J(e,"weapon-expand",t[13])},m(F,R){q(F,e,R),p(e,n),t[26](n),p(e,s),p(e,i),S&&S.m(i,null),p(i,r),p(i,o),P.m(o,null),l=rt(o,t[29].bind(o)),t[30](i),u=rt(i,t[31].bind(i)),p(e,d),_e(c,e,null),t[35](e),q(F,_,R),A&&A.m(F,R),q(F,y,R),w=!0,v||(N=[D(window,"mousedown",t[24]),D(window,"keydown",t[25]),D(n,"click",t[27])],v=!0)},p(F,R){T===(T=C(F))&&S?S.p(F,R):(S&&S.d(1),S=T&&T(F),S&&(S.c(),S.m(i,r))),R[0]&4&&de(a,a=F[2])?(Me(),G(P,1,1,X),Le(),P=Eo(F),P.c(),H(P,1),P.m(o,null)):P.p(F,R),R[0]&256&&De(o,"min-width",`${F[8]}px`),R[0]&4&&De(i,"justify-content",F[2].name?"":"flex-end");const K={};R[0]&1&&(K.slotName=F[0]),R[0]&2&&(K.index=F[1]),!f&&R[0]&4096&&(f=!0,K.slotOpen=F[12],ve(()=>f=!1)),!h&&R[0]&8192&&(h=!0,K.weaponExpand=F[13],ve(()=>h=!1)),c.$set(K),(!w||R[0]&4096)&&J(e,"slotOpen",F[12]),(!w||R[0]&8192)&&J(e,"weapon-expand",F[13]),F[13]?A?(A.p(F,R),R[0]&8192&&H(A,1)):(A=So(F),A.c(),H(A,1),A.m(y.parentNode,y)):A&&(Me(),G(A,1,1,()=>{A=null}),Le())},i(F){w||(H(P),H(c.$$.fragment,F),H(A),w=!0)},o(F){G(P),G(c.$$.fragment,F),G(A),w=!1},d(F){F&&(L(e),L(_),L(y)),t[26](null),S&&S.d(),P.d(F),l(),t[30](null),u(),pe(c),t[35](null),A&&A.d(F),v=!1,be(N)}}}function K_(t,e,n){let s,i,r,o;x(t,Et,E=>n(23,s=E)),x(t,Xt,E=>n(15,i=E)),x(t,Hs,E=>n(16,r=E)),x(t,In,E=>n(39,o=E));let{gearBox:a,slotName:l,index:u}=e,d,c,f,h,_,y,w,v=cr,N,C,T,S,P,I="";function W(){if(w)for(let E of w.querySelectorAll(".gearPreview > div")){if(Object.keys(r).includes(E.id=="basic"?N.name:C?C.name:null))return;let oe=i_(E,o);oe&&(E.id=="basic"?U(Hs,r[N.name]=oe,r):U(Hs,r[C.name]=oe,r))}}function ie(E){let oe;if(E.name=="Void Needle")oe=E.base+(i[E.type]||0)-(i.armor||0)*5.625;else if(v.name=="Pureblood Dagger"){let he,Ae={magicDmg:i.magicDmg||0,meleeDmg:i.meleeDmg||0,rangedDmg:i.rangedDmg||0},Ot=Object.keys(Ae).reduce((le,ze)=>Ae[le]>Ae[ze]?le:ze),Rt=0;for(let le in Ae)le!=Ot&&(Rt+=Ae[le]);he=(i[Ot]||0)*2-Rt,oe=E.base+he,E.name=="HP restored per Blood Sap"&&(oe/=2)}else if(E.type.includes("/")){let he=E.type.split("/"),Ae=0;for(let Ot of he)Ae+=(i[Ot]||0)*E[`${Ot}Mult`];oe=E.base+Ae}else oe=E.base+(i[E.type]||0)*E.mult;return S?Math.floor(oe*10)/10:Math.floor(oe)}function A(E){let oe,he=P?0:i[E.type]||0;return v.name=="Celestial Powers Spellbook"?oe=(80+he*1.1)*(.8+2.2*d/100):v.name=="Staff of Dreams"?oe=160+160*d/100+he*(.4+1.3*d/100):v.name=="Nature's Wrath Spellbook"&&(oe=260+400*d/4+he*(1+1.5*d/4)),Math.floor(oe*10)/10}function F(){n(14,P=!1),S?(n(13,S=!1),a.classList.remove("weapon-expand"),setTimeout(()=>{W()})):(a.classList.add("weapon-expand"),n(13,S=!0))}const R=E=>{(!c.contains(E.target)||c.contains(E.target)&&f.contains(E.target))&&n(12,T=!1)},K=E=>{E.key=="Escape"&&n(12,T=!1)};function Q(E){Z[E?"unshift":"push"](()=>{y=E,n(9,y)})}const k=()=>n(12,T=!T);function Y(E){Z[E?"unshift":"push"](()=>{w=E,n(10,w)})}function ee(){_=this.offsetHeight,n(8,_)}function j(E){Z[E?"unshift":"push"](()=>{f=E,n(6,f)})}function te(){h=this.offsetHeight,n(7,h)}function fe(E){T=E,n(12,T)}function z(E){S=E,n(13,S)}const b=()=>{setTimeout(()=>{W(),!v.name&&S&&F()})};function O(E){Z[E?"unshift":"push"](()=>{c=E,n(5,c)})}const V=E=>n(14,P=E.detail);function ne(E){d=E,n(4,d)}function Pe(E){t.$$.not_equal(v.name,E)&&(v.name=E,n(2,v),n(23,s),n(1,u),n(3,C))}return t.$$set=E=>{"gearBox"in E&&n(22,a=E.gearBox),"slotName"in E&&n(0,l=E.slotName),"index"in E&&n(1,u=E.index)},t.$$.update=()=>{t.$$.dirty[0]&8388622&&s[u]&&s[u].name!=v.name&&(n(2,v=s[u]),!v.tool&&v.name&&(n(11,N=v.moves.filter(E=>E.basic)[0]),n(3,C=v.moves.filter(E=>E.special)[0]),C&&C.name.includes("Fantastic Beamstorm")?n(17,I="~"):n(17,I="")))},[l,u,v,C,d,c,f,h,_,y,w,N,T,S,P,i,r,I,W,ie,A,F,a,s,R,K,Q,k,Y,ee,j,te,fe,z,b,O,V,ne,Pe]}class x_ extends Ne{constructor(e){super(),Te(this,e,K_,Y_,de,{gearBox:22,slotName:0,index:1},null,[-1,-1])}}function No(t,e,n){const s=t.slice();return s[3]=e[n],s}function Do(t){let e,n,s;function i(o){t[1](o)}let r={slotName:"gear",index:t[3]};return t[0]!==void 0&&(r.gearBox=t[0]),e=new x_({props:r}),Z.push(()=>we(e,"gearBox",i)),{c(){me(e.$$.fragment)},m(o,a){_e(e,o,a),s=!0},p(o,a){const l={};!n&&a&1&&(n=!0,l.gearBox=o[0],ve(()=>n=!1)),e.$set(l)},i(o){s||(H(e.$$.fragment,o),s=!0)},o(o){G(e.$$.fragment,o),s=!1},d(o){pe(e,o)}}}function Q_(t){let e,n,s=Ve(Wn),i=[];for(let o=0;o<s.length;o+=1)i[o]=Do(No(t,s,o));const r=o=>G(i[o],1,1,()=>{i[o]=null});return{c(){e=g("div");for(let o=0;o<i.length;o+=1)i[o].c();m(e,"class","gearBox svelte-13plk7j")},m(o,a){q(o,e,a);for(let l=0;l<i.length;l+=1)i[l]&&i[l].m(e,null);t[2](e),n=!0},p(o,[a]){if(a&1){s=Ve(Wn);let l;for(l=0;l<s.length;l+=1){const u=No(o,s,l);i[l]?(i[l].p(u,a),H(i[l],1)):(i[l]=Do(u),i[l].c(),H(i[l],1),i[l].m(e,null))}for(Me(),l=s.length;l<i.length;l+=1)r(l);Le()}},i(o){if(!n){for(let a=0;a<s.length;a+=1)H(i[a]);n=!0}},o(o){i=i.filter(Boolean);for(let a=0;a<i.length;a+=1)G(i[a]);n=!1},d(o){o&&L(e),Ct(i,o),t[2](null)}}}function X_(t,e,n){let s;function i(o){s=o,n(0,s)}function r(o){Z[o?"unshift":"push"](()=>{s=o,n(0,s)})}return[s,i,r]}class J_ extends Ne{constructor(e){super(),Te(this,e,X_,Q_,de,{})}}function Z_(t){let e,n,s,i,r,o,a,l;return{c(){e=g("div"),n=g("div"),s=g("button"),s.textContent="Clear armor",i=M(),r=g("div"),o=g("button"),o.textContent="Clear gear",m(s,"class","svelte-e94uvj"),m(n,"class","svelte-e94uvj"),m(o,"class","svelte-e94uvj"),m(r,"class","svelte-e94uvj"),m(e,"class","mainFeatures svelte-e94uvj"),m(e,"id","box")},m(u,d){q(u,e,d),p(e,n),p(n,s),p(e,i),p(e,r),p(r,o),a||(l=[D(s,"click",t[3]),D(o,"click",t[4])],a=!0)},p:X,i:X,o:X,d(u){u&&L(e),a=!1,be(l)}}}function $_(t,e,n){let s,i,r,o,a;x(t,Et,f=>n(5,s=f)),x(t,rs,f=>n(6,i=f)),x(t,ft,f=>n(7,r=f)),x(t,Tn,f=>n(8,o=f)),x(t,In,f=>n(0,a=f));function l(){for(let f in r)r[f].name&&o[f][r[f].name].querySelector("button").click()}function u(){for(let f in s)s[f].name&&i[f][s[f].name].querySelector("button").click()}return[a,l,u,()=>{a||l()},()=>{a||u()}]}class ep extends Ne{constructor(e){super(),Te(this,e,$_,Z_,de,{})}}function tp(t){let e,n,s,i,r,o,a;function l(d){t[2](d)}let u={slotName:"builds",index:null,weaponExpand:null};return t[0]!==void 0&&(u.slotOpen=t[0]),s=new hr({props:u}),Z.push(()=>we(s,"slotOpen",l)),{c(){e=g("button"),e.innerHTML=`Load armor set
    <iconify-icon icon="iconamoon:arrow-down-2-fill" rotate="180deg" class="svelte-l9dczq"></iconify-icon>`,n=M(),me(s.$$.fragment),m(e,"class","svelte-l9dczq"),J(e,"ddOpen",t[0])},m(d,c){q(d,e,c),q(d,n,c),_e(s,d,c),r=!0,o||(a=D(e,"click",t[1]),o=!0)},p(d,[c]){(!r||c&1)&&J(e,"ddOpen",d[0]);const f={};!i&&c&1&&(i=!0,f.slotOpen=d[0],ve(()=>i=!1)),s.$set(f)},i(d){r||(H(s.$$.fragment,d),r=!0)},o(d){G(s.$$.fragment,d),r=!1},d(d){d&&(L(e),L(n)),pe(s,d),o=!1,a()}}}function np(t,e,n){let{ddOpen:s=!1}=e;const i=()=>n(0,s=!s);function r(o){s=o,n(0,s)}return t.$$set=o=>{"ddOpen"in o&&n(0,s=o.ddOpen)},[s,i,r]}class sp extends Ne{constructor(e){super(),Te(this,e,np,tp,de,{ddOpen:0})}}function ip(t){let e;return{c(){e=g("span"),e.textContent="Create some builds to get started!",m(e,"class","tooltip svelte-1c244fb"),m(e,"id","top"),De(e,"left","70.5%")},m(n,s){q(n,e,s)},p:X,d(n){n&&L(e)}}}function rp(t){let e;return{c(){e=g("span"),e.textContent="Select some gear or armor to get started!",m(e,"class","tooltip svelte-1c244fb"),m(e,"id","top"),De(e,"left",t[3]?"38%":"")},m(n,s){q(n,e,s)},p(n,s){s&8&&De(e,"left",n[3]?"38%":"")},d(n){n&&L(e)}}}function op(t){let e,n,s,i,r,o,a,l,u,d,c,f,h,_,y,w,v,N,C,T,S,P,I,W,ie,A,F,R;function K(j,te){if(!j[4])return rp;if(!j[3])return ip}let Q=K(t),k=Q&&Q(t);function Y(j){t[18](j)}let ee={};return t[1]!==void 0&&(ee.ddOpen=t[1]),W=new sp({props:ee}),Z.push(()=>we(W,"ddOpen",Y)),{c(){e=g("div"),n=g("div"),s=g("div"),i=g("button"),r=se("Export new build"),a=M(),l=g("div"),u=g("button"),d=se("Save to build"),f=M(),h=g("div"),_=g("button"),y=se("Delete build"),v=M(),k&&k.c(),N=M(),C=g("div"),T=g("div"),S=g("button"),S.textContent="Load build",P=M(),I=g("div"),me(W.$$.fragment),i.disabled=o=!t[4],m(i,"class","svelte-1c244fb"),m(s,"class","buttonCont svelte-1c244fb"),u.disabled=c=!t[4]||!t[3],m(u,"class","svelte-1c244fb"),m(l,"class","buttonCont svelte-1c244fb"),m(l,"id","middle"),_.disabled=w=!t[3],m(_,"class","svelte-1c244fb"),m(h,"class","buttonCont svelte-1c244fb"),m(n,"id","modify"),m(n,"class","svelte-1c244fb"),J(n,"no-tooltip",t[2]),m(S,"class","svelte-1c244fb"),m(T,"class","buttonCont svelte-1c244fb"),m(I,"class","buttonCont svelte-1c244fb"),m(C,"id","load"),m(C,"class","svelte-1c244fb"),m(e,"class","mainFeatures svelte-1c244fb"),m(e,"id","build")},m(j,te){q(j,e,te),p(e,n),p(n,s),p(s,i),p(i,r),p(n,a),p(n,l),p(l,u),p(u,d),p(n,f),p(n,h),p(h,_),p(_,y),p(n,v),k&&k.m(n,null),p(e,N),p(e,C),p(C,T),p(T,S),p(C,P),p(C,I),_e(W,I,null),t[19](I),A=!0,F||(R=[D(window,"mousedown",t[8]),D(window,"keydown",t[9]),D(i,"click",t[10]),D(i,"mouseenter",t[11]),D(i,"mouseleave",t[12]),D(u,"click",t[13]),D(_,"click",t[14]),D(_,"mouseenter",t[15]),D(_,"mouseleave",t[16]),D(S,"click",t[17])],F=!0)},p(j,[te]){(!A||te&16&&o!==(o=!j[4]))&&(i.disabled=o),(!A||te&24&&c!==(c=!j[4]||!j[3]))&&(u.disabled=c),(!A||te&8&&w!==(w=!j[3]))&&(_.disabled=w),Q===(Q=K(j))&&k?k.p(j,te):(k&&k.d(1),k=Q&&Q(j),k&&(k.c(),k.m(n,null))),(!A||te&4)&&J(n,"no-tooltip",j[2]);const fe={};!ie&&te&2&&(ie=!0,fe.ddOpen=j[1],ve(()=>ie=!1)),W.$set(fe)},i(j){A||(H(W.$$.fragment,j),A=!0)},o(j){G(W.$$.fragment,j),A=!1},d(j){j&&L(e),k&&k.d(),pe(W),t[19](null),F=!1,be(R)}}}function lp(t,e,n){let s,i,r,o,a;x(t,Ze,I=>n(7,s=I)),x(t,mt,I=>n(3,i=I)),x(t,el,I=>n(4,r=I)),x(t,In,I=>n(5,o=I)),x(t,$,I=>n(6,a=I));let l,u=!1,d=!1;const c=I=>{l.contains(I.target)||n(1,u=!1)},f=I=>{I.key=="Escape"&&n(1,u=!1)},h=()=>{r&&!o&&U($,a.export.ongoing=!0,a)},_=()=>n(2,d=!0),y=()=>n(2,d=!1),w=()=>{r&&i&&!o&&U($,a.save.ongoing=!0,a)},v=()=>{i&&!o&&U($,a.delete.ongoing=!0,a)},N=()=>n(2,d=!0),C=()=>n(2,d=!1),T=()=>{o||U($,a.load.ongoing=!0,a)};function S(I){u=I,n(1,u)}function P(I){Z[I?"unshift":"push"](()=>{l=I,n(0,l)})}return t.$$.update=()=>{t.$$.dirty&128&&U(mt,i=Object.keys(s).length>0,i)},[l,u,d,i,r,o,a,s,c,f,h,_,y,w,v,N,C,T,S,P]}class ap extends Ne{constructor(e){super(),Te(this,e,lp,op,de,{})}}function Oo(t){let e;return{c(){e=g("span"),e.textContent="New changes! Exiting will erase them.",m(e,"id","alert")},m(n,s){q(n,e,s)},d(n){n&&L(e)}}}function up(t){let e,n,s,i,r,o,a,l=25-t[3].length+"",u,d,c,f,h,_,y,w,v,N,C,T=275-t[4].length+"",S,P,I,W,ie,A,F,R,K,Q,k,Y,ee,j,te,fe,z=(t[3]||t[4])&&Oo();return{c(){e=g("div"),n=g("div"),s=se(`Name:\r
        `),i=g("input"),o=M(),a=g("span"),u=se(l),d=M(),c=g("div"),f=g("div"),h=g("span"),h.textContent="Description / Notes:",_=M(),z&&z.c(),y=M(),w=g("textarea"),N=M(),C=g("span"),S=se(T),P=M(),I=g("div"),W=g("div"),ie=g("button"),A=se("CANCEL"),R=M(),K=g("div"),Q=g("button"),k=se("EXPORT"),m(i,"class","buildNameInput"),m(i,"id","firstFocusable"),i.disabled=r=t[5].export.status==0,m(i,"type","text"),m(i,"placeholder",t[6]),m(i,"maxlength","25"),m(a,"class","charCounter svelte-1vypdkl"),m(a,"id","buildName"),m(n,"class","buildNameCont svelte-1vypdkl"),m(w,"class","buildDescInput"),w.disabled=v=t[5].export.status==0,m(w,"placeholder","[Empty]"),m(w,"maxlength","275"),m(w,"autocomplete","off"),m(C,"class","charCounter"),m(C,"id","buildDesc"),m(c,"class","buildDescCont"),ie.disabled=F=t[5].export.status==0,m(Q,"id","lastFocusable"),Q.disabled=Y=t[5].export.status==0,m(I,"class","promptOptions"),m(e,"class","buildExporter svelte-1vypdkl")},m(b,O){q(b,e,O),p(e,n),p(n,s),p(n,i),t[8](i),st(i,t[3]),p(n,o),p(n,a),p(a,u),p(e,d),p(e,c),p(c,f),p(f,h),p(f,_),z&&z.m(f,null),p(c,y),p(c,w),st(w,t[4]),t[13](w),p(c,N),p(c,C),p(C,S),p(e,P),p(e,I),p(I,W),p(W,ie),p(ie,A),t[16](ie),p(I,R),p(I,K),p(K,Q),p(Q,k),j=!0,te||(fe=[D(i,"input",t[9]),D(i,"input",t[10]),D(i,"keydown",t[11]),D(w,"input",t[12]),D(w,"input",t[14]),D(w,"keydown",t[15]),D(ie,"click",t[17]),D(Q,"click",t[18]),D(Q,"keydown",pn),D(e,"introstart",t[19])],te=!0)},p(b,[O]){(!j||O&32&&r!==(r=b[5].export.status==0))&&(i.disabled=r),O&8&&i.value!==b[3]&&st(i,b[3]),(!j||O&8)&&l!==(l=25-b[3].length+"")&&ke(u,l),b[3]||b[4]?z||(z=Oo(),z.c(),z.m(f,null)):z&&(z.d(1),z=null),(!j||O&32&&v!==(v=b[5].export.status==0))&&(w.disabled=v),O&16&&st(w,b[4]),(!j||O&16)&&T!==(T=275-b[4].length+"")&&ke(S,T),(!j||O&32&&F!==(F=b[5].export.status==0))&&(ie.disabled=F),(!j||O&32&&Y!==(Y=b[5].export.status==0))&&(Q.disabled=Y)},i(b){j||(b&&ye(()=>{j&&(ee||(ee=Re(e,lt,{duration:250},!0)),ee.run(1))}),j=!0)},o(b){b&&(ee||(ee=Re(e,lt,{duration:250},!1)),ee.run(0)),j=!1},d(b){b&&L(e),t[8](null),z&&z.d(),t[13](null),t[16](null),b&&ee&&ee.end(),te=!1,be(fe)}}}function cp(t,e,n){let s,i,r,o,a,l;x(t,$,k=>n(5,s=k)),x(t,Ke,k=>n(20,i=k)),x(t,mt,k=>n(21,r=k)),x(t,Et,k=>n(22,o=k)),x(t,ft,k=>n(23,a=k)),x(t,Ze,k=>n(24,l=k));let u=Object.keys(l).length||0,d=(u+1)%10,c=d==1?"st":d==2?"nd":d==3?"rd":"th",f,h,_,y="",w="",v=`My ${u+1+c} build`;function N(){if(U($,s.export.status=0,s),y.endsWith(" ")&&n(3,y=y.replace(/  +/g," ").replace(/ $/,"")),w.endsWith(" ")&&n(4,w=w.replace(/  +/g," ").replace(/ $/,"")),Object.keys(l).includes(y)){U($,s.export.status=-1,s),U($,s.message="duplicate_name",s);return}let k=Vh(_t(an(un),"builds")).key,Y=Ua(a,o);Y.name=y||v,Y.desc=w||"[Empty]",Fs(_t(an(un),`builds/${k}`),Y).then(()=>{U($,s.export.status=1,s),U(mt,r=!0,r),fr(),Ze.update(ee=>({...ee,[Y.name]:{id:k,desc:Y.desc}})),U(Ke,i=Y,i),U(Ke,i.id=k,i),navigator.clipboard.writeText(`${location.origin+location.pathname}?id=${k}`)}).catch(()=>{U($,s.export.status=-1,s),U($,s.message="firebase_fail",s)})}function C(k){Z[k?"unshift":"push"](()=>{f=k,n(0,f)})}function T(){y=this.value,n(3,y)}const S=k=>{n(3,y=Es(k.target.value,25))},P=k=>{s.export.status==0&&k.preventDefault(),Gt(k),wi(f,k.target.value,25)};function I(){w=this.value,n(4,w)}function W(k){Z[k?"unshift":"push"](()=>{h=k,n(1,h)})}const ie=k=>{n(4,w=Es(k.target.value,275))},A=k=>{s.export.status==0&&k.preventDefault(),wi(h,k.target.value,275)};function F(k){Z[k?"unshift":"push"](()=>{_=k,n(2,_)})}return[f,h,_,y,w,s,v,N,C,T,S,P,I,W,ie,A,F,()=>{s.export.status!=0&&U($,s.export.ongoing=!1,s)},()=>{s.export.status!=0&&N()},()=>_.focus()]}class dp extends Ne{constructor(e){super(),Te(this,e,cp,up,de,{})}}function fp(t){let e,n,s,i,r=t[2]?"Copied!":"Copy link",o,a,l;return{c(){e=g("button"),n=g("b"),n.textContent="Build link",s=M(),i=g("span"),o=se(r),m(i,"class","tooltip svelte-zqs0fu"),m(i,"id","top"),m(e,"class","copyButton svelte-zqs0fu"),m(e,"id","firstFocusable")},m(u,d){q(u,e,d),p(e,n),p(e,s),p(e,i),p(i,o),a||(l=[D(e,"click",t[7]),D(e,"keydown",Gt)],a=!0)},p(u,d){d&4&&r!==(r=u[2]?"Copied!":"Copy link")&&ke(o,r)},d(u){u&&L(e),a=!1,be(l)}}}function hp(t){let e,n,s,i=t[3].id+"",r,o,a,l=t[2]?"Copied!":"Copy ID",u,d,c,f;return{c(){e=g("button"),n=g("b"),n.textContent="ID:",s=M(),r=se(i),o=M(),a=g("span"),u=se(l),m(a,"class","tooltip svelte-zqs0fu"),m(a,"id","top"),m(e,"class","copyButton svelte-zqs0fu"),m(e,"id",d=t[1]!="save"?"firstFocusable":"")},m(h,_){q(h,e,_),p(e,n),p(e,s),p(e,r),p(e,o),p(e,a),p(a,u),c||(f=[D(e,"click",t[5]),D(e,"keydown",t[6])],c=!0)},p(h,_){_&8&&i!==(i=h[3].id+"")&&ke(r,i),_&4&&l!==(l=h[2]?"Copied!":"Copy ID")&&ke(u,l),_&2&&d!==(d=h[1]!="save"?"firstFocusable":"")&&m(e,"id",d)},d(h){h&&L(e),c=!1,be(f)}}}function _p(t){let e;function n(r,o){if(r[0]=="id")return hp;if(r[0]=="link")return fp}let s=n(t),i=s&&s(t);return{c(){i&&i.c(),e=qt()},m(r,o){i&&i.m(r,o),q(r,e,o)},p(r,[o]){s===(s=n(r))&&i?i.p(r,o):(i&&i.d(1),i=s&&s(r),i&&(i.c(),i.m(e.parentNode,e)))},i:X,o:X,d(r){r&&L(e),i&&i.d(r)}}}function pp(t,e,n){let s;x(t,Ke,c=>n(3,s=c));let{type:i,source:r}=e,o=!1;function a(c){o||(navigator.clipboard.writeText(c),n(2,o=!0),setTimeout(()=>{n(2,o=!1)},1e3))}const l=()=>a(s.id),u=()=>{r!="save"&&Gt()},d=()=>a(`${location.host+location.pathname}?id=${s.id}`);return t.$$set=c=>{"type"in c&&n(0,i=c.type),"source"in c&&n(1,r=c.source)},[i,r,o,s,a,l,u,d]}class Hn extends Ne{constructor(e){super(),Te(this,e,pp,_p,de,{type:0,source:1})}}function mp(t){let e,n,s,i;return e=new Hn({props:{type:"link",source:"share"}}),s=new Hn({props:{type:"id",source:"share"}}),{c(){me(e.$$.fragment),n=M(),me(s.$$.fragment)},m(r,o){_e(e,r,o),q(r,n,o),_e(s,r,o),i=!0},p:X,i(r){i||(H(e.$$.fragment,r),H(s.$$.fragment,r),i=!0)},o(r){G(e.$$.fragment,r),G(s.$$.fragment,r),i=!1},d(r){r&&L(n),pe(e,r),pe(s,r)}}}function gp(t){let e;return{c(){e=g("span"),e.textContent="Your build has been erased from your local saves and the database."},m(n,s){q(n,e,s)},p:X,i:X,o:X,d(n){n&&L(e)}}}function bp(t){let e;function n(r,o){if(r[2].message=="not_found")return Ep;if(r[2].message=="invalid_id")return Cp}let s=n(t),i=s&&s(t);return{c(){i&&i.c(),e=qt()},m(r,o){i&&i.m(r,o),q(r,e,o)},p(r,o){s!==(s=n(r))&&(i&&i.d(1),i=s&&s(r),i&&(i.c(),i.m(e.parentNode,e)))},i:X,o:X,d(r){r&&L(e),i&&i.d(r)}}}function yp(t){let e,n,s,i,r,o;return s=new Hn({props:{type:"link",source:"save"}}),r=new Hn({props:{type:"id",source:"save"}}),{c(){e=g("span"),e.textContent="Your build has been overwritten.",n=M(),me(s.$$.fragment),i=M(),me(r.$$.fragment)},m(a,l){q(a,e,l),q(a,n,l),_e(s,a,l),q(a,i,l),_e(r,a,l),o=!0},p:X,i(a){o||(H(s.$$.fragment,a),H(r.$$.fragment,a),o=!0)},o(a){G(s.$$.fragment,a),G(r.$$.fragment,a),o=!1},d(a){a&&(L(e),L(n),L(i)),pe(s,a),pe(r,a)}}}function vp(t){let e,n,s,i;const r=[kp,Sp],o=[];function a(l,u){return l[2].export.status==1?0:l[2].export.status==-1&&l[2].message=="duplicate_name"?1:-1}return~(e=a(t))&&(n=o[e]=r[e](t)),{c(){n&&n.c(),s=qt()},m(l,u){~e&&o[e].m(l,u),q(l,s,u),i=!0},p(l,u){let d=e;e=a(l),e!==d&&(n&&(Me(),G(o[d],1,1,()=>{o[d]=null}),Le()),~e?(n=o[e],n||(n=o[e]=r[e](l),n.c()),H(n,1),n.m(s.parentNode,s)):n=null)},i(l){i||(H(n),i=!0)},o(l){G(n),i=!1},d(l){l&&L(s),~e&&o[e].d(l)}}}function wp(t){let e,n,s=t[2].export.status?"exporting":t[2].save.status?"saving":t[2].load.status?"loading":"deleting",i,r,o,a,l,u,d,c;return{c(){e=g("span"),n=se("A problem occurred while "),i=se(s),r=se(` your build.\r
            `),o=g("br"),a=se(`\r
            If needed`),l=g("b"),l.textContent=",",u=se(" you may contact "),d=g("hl"),d.textContent="xt.ss",c=se(` on Discord for more\r
            details.`)},m(f,h){q(f,e,h),p(e,n),p(e,i),p(e,r),p(e,o),p(e,a),p(e,l),p(e,u),p(e,d),p(e,c)},p(f,h){h&4&&s!==(s=f[2].export.status?"exporting":f[2].save.status?"saving":f[2].load.status?"loading":"deleting")&&ke(i,s)},i:X,o:X,d(f){f&&L(e)}}}function Cp(t){let e;return{c(){e=g("span"),e.textContent="The ID you have entered is invalid. Please check it again."},m(n,s){q(n,e,s)},d(n){n&&L(e)}}}function Ep(t){let e;return{c(){e=g("span"),e.innerHTML=`Your build could not be found within the database.
                <br/>
                If needed<b>,</b> you may contact <hl>xt.ss</hl> on Discord for more
                details.`},m(n,s){q(n,e,s)},d(n){n&&L(e)}}}function Sp(t){let e;return{c(){e=g("span"),e.innerHTML=`Another build of yours with the same name already exists.
                <br/>
                Please use a different one.`},m(n,s){q(n,e,s)},i:X,o:X,d(n){n&&L(e)}}}function kp(t){let e,n,s,i;return s=new Hn({props:{type:"id",source:"export"}}),{c(){e=g("span"),e.textContent="Your build's link has been copied to your clipboard.",n=M(),me(s.$$.fragment)},m(r,o){q(r,e,o),q(r,n,o),_e(s,r,o),i=!0},i(r){i||(H(s.$$.fragment,r),i=!0)},o(r){G(s.$$.fragment,r),i=!1},d(r){r&&(L(e),L(n)),pe(s,r)}}}function Ip(t){let e,n,s,i,r,o,a,l,u,d,c,f,h,_,y,w,v;const N=[wp,vp,yp,bp,gp,mp],C=[];function T(S,P){return S[1]==-1&&S[2].message=="firebase_fail"?0:S[2].export.status?1:S[2].save.status==1?2:S[2].load.status==-1?3:S[2].delete.status==1?4:S[2].share.ongoing?5:-1}return~(r=T(t))&&(o=C[r]=N[r](t)),{c(){e=g("div"),n=g("span"),s=se(t[4]),i=M(),o&&o.c(),a=M(),l=g("div"),u=g("div"),d=g("button"),c=se("OK"),m(n,"id","messageTitle"),m(n,"class","svelte-nfbx2w"),m(d,"id",f=(t[1]==-1?"firstFocusable ":"")+"lastFocusable"),m(l,"class","promptOptions svelte-nfbx2w"),m(e,"class","promptMessage svelte-nfbx2w")},m(S,P){q(S,e,P),p(e,n),p(n,s),p(e,i),~r&&C[r].m(e,null),p(e,a),p(e,l),p(l,u),p(u,d),p(d,c),t[6](d),y=!0,w||(v=[D(d,"click",t[7]),D(d,"keydown",t[8]),D(e,"introstart",t[9])],w=!0)},p(S,[P]){(!y||P&16)&&ke(s,S[4]);let I=r;r=T(S),r===I?~r&&C[r].p(S,P):(o&&(Me(),G(C[I],1,1,()=>{C[I]=null}),Le()),~r?(o=C[r],o?o.p(S,P):(o=C[r]=N[r](S),o.c()),H(o,1),o.m(e,a)):o=null),(!y||P&2&&f!==(f=(S[1]==-1?"firstFocusable ":"")+"lastFocusable"))&&m(d,"id",f)},i(S){y||(H(o),S&&ye(()=>{y&&(_&&_.end(1),h=Zo(e,lt,{duration:200,delay:75}),h.start())}),y=!0)},o(S){G(o),h&&h.invalidate(),S&&(_=$o(e,lt,{duration:200})),y=!1},d(S){S&&L(e),~r&&C[r].d(),t[6](null),S&&_&&_.end(),w=!1,be(v)}}}function Tp(t,e,n){let s,i,r;x(t,$,h=>n(2,r=h));let{loadID:o}=e;const a=Nt();let l;function u(h){Z[h?"unshift":"push"](()=>{l=h,n(3,l)})}const d=()=>{n(0,o=null),a("resetActions")},c=h=>{i==-1&&Gt(h),pn(h)},f=()=>l.focus();return t.$$set=h=>{"loadID"in h&&n(0,o=h.loadID)},t.$$.update=()=>{t.$$.dirty&4&&n(1,i=r.export.status||r.save.status||r.load.status||r.delete.status),t.$$.dirty&6&&n(4,s=r.share.ongoing?"Share this build":`${r.export.status?"Export":r.save.status?"Save":r.load.status?"Load":"Delete"} ${i==1?"Success":"Failure"}!`)},[o,i,r,l,s,a,u,d,c,f]}class Np extends Ne{constructor(e){super(),Te(this,e,Tp,Ip,de,{loadID:0})}}function Dp(t){let e,n,s,i,r,o;return{c(){e=g("li"),n=g("button"),s=g("span"),i=se(t[0]),m(s,"class","svelte-1opo0ke"),m(e,"class","svelte-1opo0ke"),J(e,"selectedItem",t[2])},m(a,l){q(a,e,l),p(e,n),p(n,s),p(s,i),t[7](e),r||(o=D(n,"click",t[3]),r=!0)},p(a,[l]){l&1&&ke(i,a[0]),l&4&&J(e,"selectedItem",a[2])},i:X,o:X,d(a){a&&L(e),t[7](null),r=!1,o()}}}function Op(t,e,n){let{chosenBuild:s,buildData:i,buildName:r,ddOpen:o}=e;const a=Nt();let l,u=s[0]==r;function d(){if(o){if(l.classList.contains("selectedItem")||n(2,u=!1),u)return;a("buildSelect",l),n(2,u=!0),n(5,o=!1),n(4,s=[r,i])}}function c(f){Z[f?"unshift":"push"](()=>{l=f,n(1,l)})}return t.$$set=f=>{"chosenBuild"in f&&n(4,s=f.chosenBuild),"buildData"in f&&n(6,i=f.buildData),"buildName"in f&&n(0,r=f.buildName),"ddOpen"in f&&n(5,o=f.ddOpen)},[r,l,u,d,s,o,i,c]}class Rp extends Ne{constructor(e){super(),Te(this,e,Op,Dp,de,{chosenBuild:4,buildData:6,buildName:0,ddOpen:5})}}function Ro(t,e,n){const s=t.slice();return s[25]=e[n][0],s[26]=e[n][1],s}function Ao(t){let e,n,s,i;function r(l){t[13](l)}function o(l){t[14](l)}let a={buildData:t[26],buildName:t[25]};return t[0]!==void 0&&(a.chosenBuild=t[0]),t[1]!==void 0&&(a.ddOpen=t[1]),e=new Rp({props:a}),Z.push(()=>we(e,"chosenBuild",r)),Z.push(()=>we(e,"ddOpen",o)),e.$on("buildSelect",t[11]),{c(){me(e.$$.fragment)},m(l,u){_e(e,l,u),i=!0},p(l,u){const d={};u&16&&(d.buildData=l[26]),u&16&&(d.buildName=l[25]),!n&&u&1&&(n=!0,d.chosenBuild=l[0],ve(()=>n=!1)),!s&&u&2&&(s=!0,d.ddOpen=l[1],ve(()=>s=!1)),e.$set(d)},i(l){i||(H(e.$$.fragment,l),i=!0)},o(l){G(e.$$.fragment,l),i=!1},d(l){pe(e,l)}}}function Ap(t){let e,n,s,i,r,o,a,l=Ve(Object.entries(t[4])),u=[];for(let c=0;c<l.length;c+=1)u[c]=Ao(Ro(t,l,c));const d=c=>G(u[c],1,1,()=>{u[c]=null});return{c(){e=g("div"),n=g("input"),s=M(),i=g("ul");for(let c=0;c<u.length;c+=1)u[c].c();m(n,"type","text"),m(n,"class","searchBarInput svelte-p20blu"),m(n,"placeholder","Search..."),m(i,"class","svelte-p20blu"),J(i,"no-scrollbar",t[8].length<=4),m(e,"class","dropdown svelte-p20blu"),J(e,"ddOpen",t[1])},m(c,f){q(c,e,f),p(e,n),t[12](n),p(e,s),p(e,i);for(let h=0;h<u.length;h+=1)u[h]&&u[h].m(i,null);t[15](i),t[16](e),r=!0,o||(a=[D(n,"input",t[10]),D(n,"keydown",t[9]),D(e,"transitionend",t[17]),D(e,"transitioncancel",t[18])],o=!0)},p(c,[f]){if(f&2067){l=Ve(Object.entries(c[4]));let h;for(h=0;h<l.length;h+=1){const _=Ro(c,l,h);u[h]?(u[h].p(_,f),H(u[h],1)):(u[h]=Ao(_),u[h].c(),H(u[h],1),u[h].m(i,null))}for(Me(),h=l.length;h<u.length;h+=1)d(h);Le()}(!r||f&256)&&J(i,"no-scrollbar",c[8].length<=4),(!r||f&2)&&J(e,"ddOpen",c[1])},i(c){if(!r){for(let f=0;f<l.length;f+=1)H(u[f]);r=!0}},o(c){u=u.filter(Boolean);for(let f=0;f<u.length;f+=1)G(u[f]);r=!1},d(c){c&&L(e),t[12](null),Ct(u,c),t[15](null),t[16](null),o=!1,be(a)}}}function Pp(t,e,n){let s;x(t,Ze,R=>n(4,s=R));let{chosenBuild:i,ddOpen:r=!1,dropdown:o}=e;const a=Nt();let l,u,d,c,f={},h=!1,_=[];function y(R){!R.shiftKey&&R.key=="Tab"&&(R.preventDefault(),setTimeout(()=>l.focus()))}function w(){u&&u.removeEventListener("keydown",y),C(),u&&u.addEventListener("keydown",y)}function v(R){R.shiftKey&&R.key=="Tab"&&(R.preventDefault(),setTimeout(()=>(u.querySelector("button")||u).focus()))}function N(){za(l.value,f),w()}function C(){u&&u.classList.remove("lastElement"),n(8,_=d.querySelectorAll("li:not(.hidden)")),u=_[_.length-1],u?u.classList.add("lastElement"):u=l}function T(R){a("buildSelect"),n(6,c=R.detail);let K=d.querySelector(".selectedItem");K&&K!=R.detail&&K.classList.remove("selectedItem"),n(7,h=!0)}function S(R){Z[R?"unshift":"push"](()=>{l=R,n(5,l)})}function P(R){i=R,n(0,i)}function I(R){r=R,n(1,r)}function W(R){Z[R?"unshift":"push"](()=>{d=R,n(3,d)})}function ie(R){Z[R?"unshift":"push"](()=>{o=R,n(2,o)})}const A=R=>{R.propertyName=="visibility"&&(h&&(n(7,h=!1),n(5,l.value="",l),N()),!r&&c&&d.scrollTo(0,c.offsetTop),Cs(l,r))},F=R=>{R.propertyName=="visibility"&&(n(7,h=!1),Cs(l,r))};return t.$$set=R=>{"chosenBuild"in R&&n(0,i=R.chosenBuild),"ddOpen"in R&&n(1,r=R.ddOpen),"dropdown"in R&&n(2,o=R.dropdown)},t.$$.update=()=>{if(t.$$.dirty&24&&d){n(8,_=d.querySelectorAll("li:not(.hidden)"));for(let R=0;R<d.childElementCount;R++)f[Object.keys(s)[R]]=d.children[R];C(),w()}},[i,r,o,d,s,l,c,h,_,v,N,T,S,P,I,W,ie,A,F]}class _r extends Ne{constructor(e){super(),Te(this,e,Pp,Ap,de,{chosenBuild:0,ddOpen:1,dropdown:2})}}function Po(t){let e,n=(t[6]>t[5]*.8?t[11].slice(0,20)+"<b>...</b>":t[11])+"",s;return{c(){e=g("span"),ye(()=>t[15].call(e))},m(i,r){q(i,e,r),e.innerHTML=n,s=rt(e,t[15].bind(e))},p(i,r){r[0]&2144&&n!==(n=(i[6]>i[5]*.8?i[11].slice(0,20)+"<b>...</b>":i[11])+"")&&(e.innerHTML=n)},d(i){i&&L(e),s()}}}function Mo(t){let e;return{c(){e=g("span"),e.textContent="New changes! Exiting will erase them.",m(e,"id","alert")},m(n,s){q(n,e,s)},d(n){n&&L(e)}}}function Mp(t){let e,n,s,i,r,o=t[11],a,l,u,d,c,f,h,_,y,w,v,N,C,T,S=275-t[2].length+"",P,I,W,ie,A,F,R,K,Q,k,Y,ee,j,te,fe,z,b,O,V,ne,Pe,E=Po(t),oe=t[1]!=null&&t[1]!=t[2]&&Mo();function he(le){t[26](le)}function Ae(le){t[27](le)}function Ot(le){t[28](le)}let Rt={};return t[0]!==void 0&&(Rt.chosenBuild=t[0]),t[3]!==void 0&&(Rt.ddOpen=t[3]),t[9]!==void 0&&(Rt.dropdown=t[9]),te=new _r({props:Rt}),Z.push(()=>we(te,"chosenBuild",he)),Z.push(()=>we(te,"ddOpen",Ae)),Z.push(()=>we(te,"dropdown",Ot)),te.$on("buildSelect",t[29]),{c(){e=g("div"),n=g("div"),s=g("span"),s.textContent="Save to:",i=M(),r=g("button"),E.c(),a=M(),l=g("iconify-icon"),c=M(),f=g("div"),h=g("div"),_=g("span"),_.textContent="Description / Notes:",y=M(),oe&&oe.c(),w=M(),v=g("textarea"),C=M(),T=g("span"),P=se(S),I=M(),W=g("div"),ie=g("div"),A=g("button"),F=se("CANCEL"),K=M(),Q=g("div"),k=g("button"),Y=se("SAVE"),j=M(),me(te.$$.fragment),Wt(l,"icon","iconamoon:arrow-down-2-fill"),m(r,"id","firstFocusable"),r.disabled=u=t[12].save.status==0,m(r,"class","promptDDButton svelte-106wt5q"),ye(()=>t[17].call(r)),J(r,"ddOpen",t[3]),m(n,"class","chosenBuildCont"),m(v,"class","buildDescInput"),v.disabled=N=t[12].save.status==0,m(v,"placeholder","[Empty]"),m(v,"maxlength","275"),m(v,"autocomplete","off"),m(T,"class","charCounter"),m(T,"id","buildDesc"),m(f,"class","buildDescCont"),A.disabled=R=t[12].save.status==0,m(k,"id","lastFocusable"),k.disabled=ee=t[12].save.status==0,m(W,"class","promptOptions"),m(e,"class","buildSaver")},m(le,ze){q(le,e,ze),p(e,n),p(n,s),p(n,i),p(n,r),E.m(r,null),p(r,a),p(r,l),t[16](r),d=rt(r,t[17].bind(r)),p(e,c),p(e,f),p(f,h),p(h,_),p(h,y),oe&&oe.m(h,null),p(f,w),p(f,v),t[19](v),st(v,t[10]),p(f,C),p(f,T),p(T,P),p(e,I),p(e,W),p(W,ie),p(ie,A),p(A,F),t[23](A),p(W,K),p(W,Q),p(Q,k),p(k,Y),p(e,j),_e(te,e,null),V=!0,ne||(Pe=[D(window,"mousedown",t[14]),D(r,"click",t[18]),D(r,"keydown",Gt),D(v,"input",t[20]),D(v,"input",t[21]),D(v,"keydown",t[22]),D(A,"click",t[24]),D(k,"click",t[25]),D(k,"keydown",pn),D(e,"introstart",t[30]),D(e,"keydown",t[31])],ne=!0)},p(le,ze){ze[0]&2048&&de(o,o=le[11])?(E.d(1),E=Po(le),E.c(),E.m(r,a)):E.p(le,ze),(!V||ze[0]&4096&&u!==(u=le[12].save.status==0))&&(r.disabled=u),(!V||ze[0]&8)&&J(r,"ddOpen",le[3]),le[1]!=null&&le[1]!=le[2]?oe||(oe=Mo(),oe.c(),oe.m(h,null)):oe&&(oe.d(1),oe=null),(!V||ze[0]&4096&&N!==(N=le[12].save.status==0))&&(v.disabled=N),ze[0]&1024&&st(v,le[10]),(!V||ze[0]&4)&&S!==(S=275-le[2].length+"")&&ke(P,S),(!V||ze[0]&4096&&R!==(R=le[12].save.status==0))&&(A.disabled=R),(!V||ze[0]&4096&&ee!==(ee=le[12].save.status==0))&&(k.disabled=ee);const xn={};!fe&&ze[0]&1&&(fe=!0,xn.chosenBuild=le[0],ve(()=>fe=!1)),!z&&ze[0]&8&&(z=!0,xn.ddOpen=le[3],ve(()=>z=!1)),!b&&ze[0]&512&&(b=!0,xn.dropdown=le[9],ve(()=>b=!1)),te.$set(xn)},i(le){V||(H(te.$$.fragment,le),le&&ye(()=>{V&&(O||(O=Re(e,lt,{duration:250},!0)),O.run(1))}),V=!0)},o(le){G(te.$$.fragment,le),le&&(O||(O=Re(e,lt,{duration:250},!1)),O.run(0)),V=!1},d(le){le&&L(e),E.d(le),t[16](null),d(),oe&&oe.d(),t[19](null),t[23](null),pe(te),le&&O&&O.end(),ne=!1,be(Pe)}}}function Lp(t,e,n){let s,i,r,o,a,l,u,d;x(t,$,O=>n(12,o=O)),x(t,Ke,O=>n(32,a=O)),x(t,Ze,O=>n(33,l=O)),x(t,Et,O=>n(34,u=O)),x(t,ft,O=>n(35,d=O));let c=!1,f,h,_,y,w,v,N=Object.entries(l)[0],C=null;function T(){U($,o.save.status=0,o);let O=Ua(d,u),V=C==null?i:C==""?"[Empty]":C,ne=N[1].id;O.name=s,O.desc=V,Fs(_t(an(un),`builds/${ne}`),O).then(()=>{U($,o.save.status=1,o);let Pe={...l};Pe[s].desc=V,fr(),Ze.update(()=>Pe),U(Ke,a=O,a),U(Ke,a.id=ne,a)}).catch(()=>{U($,o.save.status=-1,o),U($,o.message="firebase_fail",o)})}const S=O=>{!f.contains(O.target)&&!v.contains(O.target)&&n(3,c=!1)};function P(){_=this.offsetWidth,n(6,_)}function I(O){Z[O?"unshift":"push"](()=>{f=O,n(4,f)})}function W(){h=this.offsetWidth,n(5,h)}const ie=()=>{o.save.status!=0&&n(3,c=!c)};function A(O){Z[O?"unshift":"push"](()=>{y=O,n(7,y)})}function F(){r=this.value,n(10,r),n(1,C),n(2,i),n(0,N)}const R=O=>{n(1,C=Es(O.target.value,275))},K=O=>{o.save.status==0&&O.preventDefault(),wi(y,O.target.value,275)};function Q(O){Z[O?"unshift":"push"](()=>{w=O,n(8,w)})}const k=()=>{o.save.status!=0&&U($,o.save.ongoing=!1,o)},Y=()=>{o.save.status!=0&&T()};function ee(O){N=O,n(0,N)}function j(O){c=O,n(3,c)}function te(O){v=O,n(9,v)}const fe=()=>n(1,C=null),z=()=>w.focus(),b=O=>{O.key=="Escape"&&(n(3,c=!1),f.focus())};return t.$$.update=()=>{t.$$.dirty[0]&1&&n(11,s=N[0]),t.$$.dirty[0]&1&&n(2,i=N[1].desc),t.$$.dirty[0]&6&&n(10,r=C??i)},[N,C,i,c,f,h,_,y,w,v,r,s,o,T,S,P,I,W,ie,A,F,R,K,Q,k,Y,ee,j,te,fe,z,b]}class Bp extends Ne{constructor(e){super(),Te(this,e,Lp,Mp,de,{},null,[-1,-1])}}function Fp(t){let e,n,s,i,r,o,a,l,u;return{c(){e=g("div"),n=g("span"),n.textContent="ID:",s=M(),i=g("input"),m(i,"class","buildIDInput svelte-1wfx9qu"),i.disabled=r=t[11].load.status==0,m(i,"type","text"),m(i,"placeholder","Example ID: -NDqeA1Scn0EAJcYWN3b"),m(i,"maxlength","25"),m(e,"class","buildIDCont svelte-1wfx9qu")},m(d,c){q(d,e,c),p(e,n),p(e,s),p(e,i),t[21](i),st(i,t[10]),a=!0,l||(u=[D(i,"input",t[22]),D(i,"input",t[23]),D(i,"keydown",t[24])],l=!0)},p(d,c){(!a||c[0]&2048&&r!==(r=d[11].load.status==0))&&(i.disabled=r),c[0]&1024&&i.value!==d[10]&&st(i,d[10])},i(d){a||(d&&ye(()=>{a&&(o||(o=Re(e,je,{duration:150},!0)),o.run(1))}),a=!0)},o(d){d&&(o||(o=Re(e,je,{duration:150},!1)),o.run(0)),a=!1},d(d){d&&L(e),t[21](null),d&&o&&o.end(),l=!1,be(u)}}}function qp(t){let e,n,s,i,r=t[9],o,a,l,u,d,c,f,h,_=Lo(t);return{c(){e=g("div"),n=g("span"),n.textContent="Load:",s=M(),i=g("button"),_.c(),o=M(),a=g("iconify-icon"),Wt(a,"icon","iconamoon:arrow-down-2-fill"),i.disabled=l=t[11].load.status==0,m(i,"class","promptDDButton svelte-1wfx9qu"),ye(()=>t[19].call(i)),J(i,"ddOpen",t[8]),m(e,"class","chosenBuildCont svelte-1wfx9qu")},m(y,w){q(y,e,w),p(e,n),p(e,s),p(e,i),_.m(i,null),p(i,o),p(i,a),t[18](i),u=rt(i,t[19].bind(i)),c=!0,f||(h=D(i,"click",t[20]),f=!0)},p(y,w){w[0]&512&&de(r,r=y[9])?(_.d(1),_=Lo(y),_.c(),_.m(i,o)):_.p(y,w),(!c||w[0]&2048&&l!==(l=y[11].load.status==0))&&(i.disabled=l),(!c||w[0]&256)&&J(i,"ddOpen",y[8])},i(y){c||(y&&ye(()=>{c&&(d||(d=Re(e,je,{duration:150},!0)),d.run(1))}),c=!0)},o(y){y&&(d||(d=Re(e,je,{duration:150},!1)),d.run(0)),c=!1},d(y){y&&L(e),_.d(y),t[18](null),u(),y&&d&&d.end(),f=!1,h()}}}function Lo(t){let e,n=(t[6]>t[5]*.7?t[9].slice(0,20)+"<b>...</b>":t[9])+"",s;return{c(){e=g("span"),ye(()=>t[17].call(e))},m(i,r){q(i,e,r),e.innerHTML=n,s=rt(e,t[17].bind(e))},p(i,r){r[0]&608&&n!==(n=(i[6]>i[5]*.7?i[9].slice(0,20)+"<b>...</b>":i[9])+"")&&(e.innerHTML=n)},d(i){i&&L(e),s()}}}function Bo(t){let e,n,s,i,r;function o(d){t[27](d)}function a(d){t[28](d)}function l(d){t[29](d)}let u={};return t[3]!==void 0&&(u.chosenBuild=t[3]),t[8]!==void 0&&(u.ddOpen=t[8]),t[7]!==void 0&&(u.dropdown=t[7]),e=new _r({props:u}),Z.push(()=>we(e,"chosenBuild",o)),Z.push(()=>we(e,"ddOpen",a)),Z.push(()=>we(e,"dropdown",l)),{c(){me(e.$$.fragment)},m(d,c){_e(e,d,c),r=!0},p(d,c){const f={};!n&&c[0]&8&&(n=!0,f.chosenBuild=d[3],ve(()=>n=!1)),!s&&c[0]&256&&(s=!0,f.ddOpen=d[8],ve(()=>s=!1)),!i&&c[0]&128&&(i=!0,f.dropdown=d[7],ve(()=>i=!1)),e.$set(f)},i(d){r||(H(e.$$.fragment,d),r=!0)},o(d){G(e.$$.fragment,d),r=!1},d(d){pe(e,d)}}}function Wp(t){let e,n,s,i,r,o,a,l,u,d,c,f,h,_,y,w,v,N,C,T,S,P,I,W,ie,A,F,R,K,Q,k,Y,ee;const j=[qp,Fp],te=[];function fe(b,O){return b[2]?0:1}w=fe(t),v=te[w]=j[w](t);let z=t[2]&&Bo(t);return{c(){e=g("div"),n=g("span"),n.textContent="Load build via:",s=M(),i=g("div"),r=g("div"),o=g("button"),a=se("Local saves"),u=M(),d=g("div"),c=g("button"),f=se("Exported ID"),_=M(),y=g("div"),v.c(),N=M(),C=g("div"),T=g("div"),S=g("button"),P=se("CANCEL"),W=M(),ie=g("div"),A=g("button"),F=se("LOAD"),K=M(),z&&z.c(),m(n,"class","svelte-1wfx9qu"),m(o,"id","firstFocusable"),o.disabled=l=t[11].load.status==0||!t[12],m(o,"class","svelte-1wfx9qu"),J(o,"chosen",t[2]),J(o,"unavailable",!t[12]),m(r,"class","svelte-1wfx9qu"),c.disabled=h=t[11].load.status==0,m(c,"class","svelte-1wfx9qu"),J(c,"chosen",!t[2]),m(d,"class","svelte-1wfx9qu"),m(i,"class","loadMethodRadio svelte-1wfx9qu"),m(y,"class","loadMethodCont svelte-1wfx9qu"),S.disabled=I=t[11].load.status==0,m(A,"id","lastFocusable"),A.disabled=R=t[11].load.status==0,m(C,"class","promptOptions svelte-1wfx9qu"),m(e,"class","buildLoader svelte-1wfx9qu")},m(b,O){q(b,e,O),p(e,n),p(e,s),p(e,i),p(i,r),p(r,o),p(o,a),p(i,u),p(i,d),p(d,c),p(c,f),p(e,_),p(e,y),te[w].m(y,null),p(e,N),p(e,C),p(C,T),p(T,S),p(S,P),t[25](S),p(C,W),p(C,ie),p(ie,A),p(A,F),p(e,K),z&&z.m(e,null),k=!0,Y||(ee=[D(window,"mousedown",t[14]),D(o,"click",t[15]),D(o,"keydown",Gt),D(c,"click",t[16]),D(S,"click",t[26]),D(A,"keydown",pn),D(A,"click",t[13]),D(e,"introstart",t[30]),D(e,"keydown",t[31])],Y=!0)},p(b,O){(!k||O[0]&6144&&l!==(l=b[11].load.status==0||!b[12]))&&(o.disabled=l),(!k||O[0]&4)&&J(o,"chosen",b[2]),(!k||O[0]&4096)&&J(o,"unavailable",!b[12]),(!k||O[0]&2048&&h!==(h=b[11].load.status==0))&&(c.disabled=h),(!k||O[0]&4)&&J(c,"chosen",!b[2]);let V=w;w=fe(b),w===V?te[w].p(b,O):(Me(),G(te[V],1,1,()=>{te[V]=null}),Le(),v=te[w],v?v.p(b,O):(v=te[w]=j[w](b),v.c()),H(v,1),v.m(y,null)),(!k||O[0]&2048&&I!==(I=b[11].load.status==0))&&(S.disabled=I),(!k||O[0]&2048&&R!==(R=b[11].load.status==0))&&(A.disabled=R),b[2]?z?(z.p(b,O),O[0]&4&&H(z,1)):(z=Bo(b),z.c(),H(z,1),z.m(e,null)):z&&(Me(),G(z,1,1,()=>{z=null}),Le())},i(b){k||(H(v),H(z),b&&ye(()=>{k&&(Q||(Q=Re(e,lt,{duration:250},!0)),Q.run(1))}),k=!0)},o(b){G(v),G(z),b&&(Q||(Q=Re(e,lt,{duration:250},!1)),Q.run(0)),k=!1},d(b){b&&L(e),te[w].d(),t[25](null),z&&z.d(),b&&Q&&Q.end(),Y=!1,be(ee)}}}function Hp(t,e,n){let s,i,r;x(t,$,z=>n(11,s=z)),x(t,Ze,z=>n(32,i=z)),x(t,mt,z=>n(12,r=z));const o=Nt();let a,l,u,d,c,f,h=r,_=!1,y=r?Object.entries(i)[0]:null,w,v="";function N(){if(!h&&!v.startsWith("-N")){U($,s.load.status=-1,s),U($,s.message="invalid_id",s);return}let z=Wa(an(un,"builds"),qa()),b=0;U($,s.load.status=0,s),Fa(z).then(O=>{let V=h?y[1].id:v;for(let ne in O.val()){if(ne==V){o("buildLoad",{build:O.val()[ne],id:ne});break}else b==Object.keys(O.val()).length-1&&(U($,s.load.status=-1,s),U($,s.message=h?"not_found":"invalid_id",s));b++}}).catch(()=>{U($,s.load.status=-1,s),U($,s.message="firebase_fail",s)})}const C=z=>{a&&!a.contains(z.target)&&!f.contains(z.target)&&n(8,_=!1)},T=()=>{s.load.status!=0&&r&&n(2,h=!0)},S=()=>{s.load.status!=0&&n(2,h=!1)};function P(){c=this.offsetWidth,n(6,c)}function I(z){Z[z?"unshift":"push"](()=>{a=z,n(0,a)})}function W(){d=this.offsetWidth,n(5,d)}const ie=()=>{s.load.status!=0&&n(8,_=!_)};function A(z){Z[z?"unshift":"push"](()=>{u=z,n(1,u)})}function F(){v=this.value,n(10,v)}const R=z=>{n(10,v=Es(z.target.value,25))},K=z=>{s.load.status==0&&z.preventDefault()};function Q(z){Z[z?"unshift":"push"](()=>{l=z,n(4,l)})}const k=()=>{s.load.status!=0&&U($,s.load.ongoing=!1,s)};function Y(z){y=z,n(3,y)}function ee(z){_=z,n(8,_)}function j(z){f=z,n(7,f)}const te=()=>l.focus(),fe=z=>{z.key=="Escape"&&(n(8,_=!1),a.focus())};return t.$$.update=()=>{t.$$.dirty[0]&8&&n(9,w=y!=null?y[0]:null),t.$$.dirty[0]&7&&setTimeout(h?()=>a.focus():()=>u.focus())},[a,u,h,y,l,d,c,f,_,w,v,s,r,N,C,T,S,P,I,W,ie,A,F,R,K,Q,k,Y,ee,j,te,fe]}class zp extends Ne{constructor(e){super(),Te(this,e,Hp,Wp,de,{},null,[-1,-1])}}function Fo(t){let e,n=(t[3]>t[4]*.8?t[8].slice(0,20)+"<b>...</b>":t[8])+"",s;return{c(){e=g("span"),ye(()=>t[12].call(e))},m(i,r){q(i,e,r),e.innerHTML=n,s=rt(e,t[12].bind(e))},p(i,r){r&280&&n!==(n=(i[3]>i[4]*.8?i[8].slice(0,20)+"<b>...</b>":i[8])+"")&&(e.innerHTML=n)},d(i){i&&L(e),s()}}}function Up(t){let e,n,s,i,r,o=t[8],a,l,u,d,c,f,h,_,y,w,v,N,C,T,S,P,I,W,ie,A,F,R,K,Q,k,Y,ee,j,te=Fo(t);f=new Va({props:{text:"I'm aware that this action is irreversible and want to erase this build from the database."}}),f.$on("toggle",t[16]);function fe(V){t[21](V)}function z(V){t[22](V)}function b(V){t[23](V)}let O={};return t[0]!==void 0&&(O.chosenBuild=t[0]),t[6]!==void 0&&(O.ddOpen=t[6]),t[5]!==void 0&&(O.dropdown=t[5]),F=new _r({props:O}),Z.push(()=>we(F,"chosenBuild",fe)),Z.push(()=>we(F,"ddOpen",z)),Z.push(()=>we(F,"dropdown",b)),{c(){e=g("div"),n=g("div"),s=g("span"),s.textContent="Delete:",i=M(),r=g("button"),te.c(),a=M(),l=g("iconify-icon"),c=M(),me(f.$$.fragment),h=M(),_=g("div"),y=g("div"),w=g("button"),v=se("CANCEL"),T=M(),S=g("div"),P=g("button"),I=se("DELETE"),A=M(),me(F.$$.fragment),Wt(l,"icon","iconamoon:arrow-down-2-fill"),m(r,"class","promptDDButton svelte-1t9ajmz"),m(r,"id","firstFocusable"),r.disabled=u=t[9].delete.status==0,ye(()=>t[14].call(r)),J(r,"ddOpen",t[6]),m(n,"class","chosenBuildCont"),m(w,"id",N=t[7]?"":"lastFocusable"),w.disabled=C=t[9].delete.status==0,P.disabled=W=!t[7]||t[9].delete.status==0,m(P,"id",ie=t[7]?"lastFocusable":""),J(P,"unavailable",!t[7]),m(_,"class","promptOptions svelte-1t9ajmz"),m(e,"class","buildDeleter svelte-1t9ajmz")},m(V,ne){q(V,e,ne),p(e,n),p(n,s),p(n,i),p(n,r),te.m(r,null),p(r,a),p(r,l),t[13](r),d=rt(r,t[14].bind(r)),p(e,c),_e(f,e,null),p(e,h),p(e,_),p(_,y),p(y,w),p(w,v),t[17](w),p(_,T),p(_,S),p(S,P),p(P,I),p(e,A),_e(F,e,null),Y=!0,ee||(j=[D(window,"mousedown",t[11]),D(r,"click",t[15]),D(r,"keydown",Gt),D(w,"click",t[18]),D(w,"keydown",t[19]),D(P,"click",t[20]),D(P,"keydown",pn),D(e,"introstart",t[24]),D(e,"keydown",t[25])],ee=!0)},p(V,[ne]){ne&256&&de(o,o=V[8])?(te.d(1),te=Fo(V),te.c(),te.m(r,a)):te.p(V,ne),(!Y||ne&512&&u!==(u=V[9].delete.status==0))&&(r.disabled=u),(!Y||ne&64)&&J(r,"ddOpen",V[6]),(!Y||ne&128&&N!==(N=V[7]?"":"lastFocusable"))&&m(w,"id",N),(!Y||ne&512&&C!==(C=V[9].delete.status==0))&&(w.disabled=C),(!Y||ne&640&&W!==(W=!V[7]||V[9].delete.status==0))&&(P.disabled=W),(!Y||ne&128&&ie!==(ie=V[7]?"lastFocusable":""))&&m(P,"id",ie),(!Y||ne&128)&&J(P,"unavailable",!V[7]);const Pe={};!R&&ne&1&&(R=!0,Pe.chosenBuild=V[0],ve(()=>R=!1)),!K&&ne&64&&(K=!0,Pe.ddOpen=V[6],ve(()=>K=!1)),!Q&&ne&32&&(Q=!0,Pe.dropdown=V[5],ve(()=>Q=!1)),F.$set(Pe)},i(V){Y||(H(f.$$.fragment,V),H(F.$$.fragment,V),V&&ye(()=>{Y&&(k||(k=Re(e,lt,{duration:250},!0)),k.run(1))}),Y=!0)},o(V){G(f.$$.fragment,V),G(F.$$.fragment,V),V&&(k||(k=Re(e,lt,{duration:250},!1)),k.run(0)),Y=!1},d(V){V&&L(e),te.d(V),t[13](null),d(),pe(f),t[17](null),pe(F),V&&k&&k.end(),ee=!1,be(j)}}}function Vp(t,e,n){let s,i,r,o;x(t,$,k=>n(9,i=k)),x(t,Ze,k=>n(26,r=k)),x(t,Ke,k=>n(27,o=k));let a,l,u,d,c,f=!1,h=Object.entries(r)[0],_=!1;function y(){U($,i.delete.status=0,i);let k=h[1].id;jh(_t(an(un),`builds/${k}`)).then(()=>{U($,i.delete.status=1,i),o&&k==o.id&&U(Ke,o=null,o);let Y={...r};delete Y[s],fr(),Ze.update(()=>Y)}).catch(Y=>{console.log(Y),U($,i.delete.status=-1,i),U($,i.message="firebase_fail",i)})}const w=k=>{!l.contains(k.target)&&!c.contains(k.target)&&n(6,f=!1)};function v(){u=this.offsetWidth,n(3,u)}function N(k){Z[k?"unshift":"push"](()=>{l=k,n(2,l)})}function C(){d=this.offsetWidth,n(4,d)}const T=()=>{i.delete.status!=0&&n(6,f=!f)},S=k=>n(7,_=k.detail);function P(k){Z[k?"unshift":"push"](()=>{a=k,n(1,a)})}const I=()=>{i.delete.status!=0&&U($,i.delete.ongoing=!1,i)},W=k=>{_||pn(k)},ie=()=>{_&&i.delete.status!=0&&y()};function A(k){h=k,n(0,h)}function F(k){f=k,n(6,f)}function R(k){c=k,n(5,c)}const K=()=>a.focus(),Q=k=>{k.key=="Escape"&&(n(6,f=!1),l.focus())};return t.$$.update=()=>{t.$$.dirty&1&&n(8,s=h[0])},[h,a,l,u,d,c,f,_,s,i,y,w,v,N,C,T,S,P,I,W,ie,A,F,R,K,Q]}class jp extends Ne{constructor(e){super(),Te(this,e,Vp,Up,de,{})}}const{document:$n,window:Zt}=Qa;function qo(t,e,n){const s=t.slice();return s[40]=e[n],s}function Wo(t,e,n){const s=t.slice();return s[40]=e[n],s}function Ho(t){let e;return{c(){e=g("link"),m(e,"rel","preload"),m(e,"as","image"),m(e,"href",t[40])},m(n,s){q(n,e,s)},p:X,d(n){n&&L(e)}}}function zo(t){let e;return{c(){e=g("style"),e.textContent=`body > div:not(.zoomLevel),\r
            main > :not(.promptCont) {\r
                filter: blur(calc(var(--u) * 0.5));\r
                pointer-events: none;\r
            }`},m(n,s){q(n,e,s)},d(n){n&&L(e)}}}function Uo(t){let e,n;return{c(){e=g("img"),m(e,"class","background svelte-qtnq98"),Je(e.src,n=t[40])||m(e,"src",n),m(e,"alt",""),J(e,"active",t[15].indexOf(t[40])==t[7])},m(s,i){q(s,e,i)},p(s,i){i[0]&32896&&J(e,"active",s[15].indexOf(s[40])==s[7])},d(s){s&&L(e)}}}function Vo(t){let e,n,s=Math.floor(t[13][t[2]]*100)+"",i,r,o,a;return{c(){e=g("div"),n=se("Zoom: "),i=se(s),r=g("b"),r.textContent="%",m(e,"class","zoomLevel svelte-qtnq98")},m(l,u){q(l,e,u),p(e,n),p(e,i),p(e,r),a=!0},p(l,u){(!a||u[0]&4)&&s!==(s=Math.floor(l[13][l[2]]*100)+"")&&ke(i,s)},i(l){a||(l&&ye(()=>{a&&(o||(o=Re(e,je,{duration:150},!0)),o.run(1))}),a=!0)},o(l){l&&(o||(o=Re(e,je,{duration:150},!1)),o.run(0)),a=!1},d(l){l&&L(e),l&&o&&o.end()}}}function jo(t){let e,n,s=t[3].name+"",i,r,o,a,l,u,d,c,f,h,_=t[3].desc+"",y,w,v,N,C;return{c(){e=g("div"),n=g("span"),i=se(s),r=M(),o=g("button"),o.innerHTML='<iconify-icon icon="ri:share-fill"></iconify-icon> <span class="tooltip" id="right">Share build</span>',a=M(),l=g("span"),u=se(`Description / Notes:\r
                `),d=g("br"),c=M(),f=g("br"),h=M(),y=se(_),m(n,"id","buildName"),m(n,"class","svelte-qtnq98"),m(o,"class","svelte-qtnq98"),m(l,"class","tooltip"),m(l,"id","bottom"),m(e,"class","currentBuild svelte-qtnq98"),J(e,"no-tooltip",t[8])},m(T,S){q(T,e,S),p(e,n),p(n,i),p(e,r),p(e,o),p(e,a),p(e,l),p(l,u),p(l,d),p(l,c),p(l,f),p(l,h),p(l,y),v=!0,N||(C=[D(o,"click",t[24]),D(o,"mouseenter",t[25]),D(o,"mouseleave",t[26])],N=!0)},p(T,S){(!v||S[0]&8)&&s!==(s=T[3].name+"")&&ke(i,s),(!v||S[0]&8)&&_!==(_=T[3].desc+"")&&ke(y,_),(!v||S[0]&256)&&J(e,"no-tooltip",T[8])},i(T){v||(T&&ye(()=>{v&&(w||(w=Re(e,je,{duration:100},!0)),w.run(1))}),v=!0)},o(T){T&&(w||(w=Re(e,je,{duration:100},!1)),w.run(0)),v=!1},d(T){T&&L(e),T&&w&&w.end(),N=!1,be(C)}}}function Gp(t){let e,n,s;return n=new jp({}),{c(){e=g("div"),me(n.$$.fragment),m(e,"class","promptCont svelte-qtnq98")},m(i,r){q(i,e,r),_e(n,e,null),s=!0},p:X,i(i){s||(H(n.$$.fragment,i),s=!0)},o(i){G(n.$$.fragment,i),s=!1},d(i){i&&L(e),pe(n)}}}function Yp(t){let e,n,s;return n=new zp({}),n.$on("buildLoad",t[28]),{c(){e=g("div"),me(n.$$.fragment),m(e,"class","promptCont svelte-qtnq98")},m(i,r){q(i,e,r),_e(n,e,null),s=!0},p:X,i(i){s||(H(n.$$.fragment,i),s=!0)},o(i){G(n.$$.fragment,i),s=!1},d(i){i&&L(e),pe(n)}}}function Kp(t){let e,n,s;return n=new Bp({}),{c(){e=g("div"),me(n.$$.fragment),m(e,"class","promptCont svelte-qtnq98")},m(i,r){q(i,e,r),_e(n,e,null),s=!0},p:X,i(i){s||(H(n.$$.fragment,i),s=!0)},o(i){G(n.$$.fragment,i),s=!1},d(i){i&&L(e),pe(n)}}}function xp(t){let e,n,s;return n=new dp({}),{c(){e=g("div"),me(n.$$.fragment),m(e,"class","promptCont svelte-qtnq98")},m(i,r){q(i,e,r),_e(n,e,null),s=!0},p:X,i(i){s||(H(n.$$.fragment,i),s=!0)},o(i){G(n.$$.fragment,i),s=!1},d(i){i&&L(e),pe(n)}}}function Qp(t){let e,n,s,i;function r(a){t[27](a)}let o={};return t[6]!==void 0&&(o.loadID=t[6]),n=new Np({props:o}),Z.push(()=>we(n,"loadID",r)),n.$on("resetActions",t[17]),{c(){e=g("div"),me(n.$$.fragment),m(e,"class","promptCont svelte-qtnq98")},m(a,l){q(a,e,l),_e(n,e,null),i=!0},p(a,l){const u={};!s&&l[0]&64&&(s=!0,u.loadID=a[6],ve(()=>s=!1)),n.$set(u)},i(a){i||(H(n.$$.fragment,a),i=!0)},o(a){G(n.$$.fragment,a),i=!1},d(a){a&&L(e),pe(n)}}}function Xp(t){let e,n,s,i,r,o,a,l,u,d,c,f,h,_,y,w,v,N,C,T,S,P,I,W,ie,A,F;ye(t[23]);let R=Ve(t[15]),K=[];for(let b=0;b<R.length;b+=1)K[b]=Ho(Wo(t,R,b));let Q=t[10]&&zo(),k=Ve(t[15]),Y=[];for(let b=0;b<k.length;b+=1)Y[b]=Uo(qo(t,k,b));let ee=t[5]&&Vo(t),j=t[3]&&jo(t);c=new ep({}),y=new O_({}),v=new q_({}),C=new J_({}),S=new ap({});const te=[Qp,xp,Kp,Yp,Gp],fe=[];function z(b,O){return b[9]||b[4].share.ongoing?0:b[4].export.ongoing?1:b[4].save.ongoing?2:b[4].load.ongoing&&!b[6]?3:b[4].delete.ongoing?4:-1}return~(I=z(t))&&(W=fe[I]=te[I](t)),{c(){for(let b=0;b<K.length;b+=1)K[b].c();e=qt(),Q&&Q.c(),n=qt(),s=M(),i=g("div");for(let b=0;b<Y.length;b+=1)Y[b].c();r=M(),o=g("div"),o.textContent=`${Jp}`,a=M(),ee&&ee.c(),l=M(),u=g("main"),j&&j.c(),d=M(),me(c.$$.fragment),f=M(),h=g("div"),_=g("div"),me(y.$$.fragment),w=M(),me(v.$$.fragment),N=M(),me(C.$$.fragment),T=M(),me(S.$$.fragment),P=M(),W&&W.c(),m(o,"style","position: absolute; right: 0; padding: var(--u); font-size: calc(var(--u) * 2.5); color: var(--light);"),m(_,"class","eqCont svelte-qtnq98"),m(h,"class","calcBox svelte-qtnq98"),m(h,"id","calc"),m(u,"class","svelte-qtnq98")},m(b,O){for(let V=0;V<K.length;V+=1)K[V]&&K[V].m($n.head,null);p($n.head,e),Q&&Q.m($n.head,null),p($n.head,n),q(b,s,O),q(b,i,O);for(let V=0;V<Y.length;V+=1)Y[V]&&Y[V].m(i,null);q(b,r,O),q(b,o,O),q(b,a,O),ee&&ee.m(b,O),q(b,l,O),q(b,u,O),j&&j.m(u,null),p(u,d),_e(c,u,null),p(u,f),p(u,h),p(h,_),_e(y,_,null),p(_,w),_e(v,_,null),p(h,N),_e(C,h,null),p(u,T),_e(S,u,null),p(u,P),~I&&fe[I].m(u,null),ie=!0,A||(F=[D(Zt,"storage",t[20]),D(Zt,"wheel",t[21],{passive:!1}),D(Zt,"keydown",t[22]),D(Zt,"resize",t[23])],A=!0)},p(b,O){if(O[0]&32768){R=Ve(b[15]);let ne;for(ne=0;ne<R.length;ne+=1){const Pe=Wo(b,R,ne);K[ne]?K[ne].p(Pe,O):(K[ne]=Ho(Pe),K[ne].c(),K[ne].m(e.parentNode,e))}for(;ne<K.length;ne+=1)K[ne].d(1);K.length=R.length}if(b[10]?Q||(Q=zo(),Q.c(),Q.m(n.parentNode,n)):Q&&(Q.d(1),Q=null),O[0]&32896){k=Ve(b[15]);let ne;for(ne=0;ne<k.length;ne+=1){const Pe=qo(b,k,ne);Y[ne]?Y[ne].p(Pe,O):(Y[ne]=Uo(Pe),Y[ne].c(),Y[ne].m(i,null))}for(;ne<Y.length;ne+=1)Y[ne].d(1);Y.length=k.length}b[5]?ee?(ee.p(b,O),O[0]&32&&H(ee,1)):(ee=Vo(b),ee.c(),H(ee,1),ee.m(l.parentNode,l)):ee&&(Me(),G(ee,1,1,()=>{ee=null}),Le()),b[3]?j?(j.p(b,O),O[0]&8&&H(j,1)):(j=jo(b),j.c(),H(j,1),j.m(u,d)):j&&(Me(),G(j,1,1,()=>{j=null}),Le());let V=I;I=z(b),I===V?~I&&fe[I].p(b,O):(W&&(Me(),G(fe[V],1,1,()=>{fe[V]=null}),Le()),~I?(W=fe[I],W?W.p(b,O):(W=fe[I]=te[I](b),W.c()),H(W,1),W.m(u,null)):W=null)},i(b){ie||(H(ee),H(j),H(c.$$.fragment,b),H(y.$$.fragment,b),H(v.$$.fragment,b),H(C.$$.fragment,b),H(S.$$.fragment,b),H(W),ie=!0)},o(b){G(ee),G(j),G(c.$$.fragment,b),G(y.$$.fragment,b),G(v.$$.fragment,b),G(C.$$.fragment,b),G(S.$$.fragment,b),G(W),ie=!1},d(b){b&&(L(s),L(i),L(r),L(o),L(a),L(l),L(u)),Ct(K,b),L(e),Q&&Q.d(b),L(n),Ct(Y,b),ee&&ee.d(b),j&&j.d(),pe(c),pe(y),pe(v),pe(C),pe(S),~I&&fe[I].d(),A=!1,be(F)}}}let Jp="3.17.6-alpha";function Zp(t,e,n){let s,i,r,o,a,l,u,d,c,f,h;x(t,Ke,E=>n(3,i=E)),x(t,$,E=>n(4,r=E)),x(t,In,E=>n(10,o=E)),x(t,Di,E=>n(19,a=E)),x(t,rs,E=>n(32,l=E)),x(t,Et,E=>n(33,u=E)),x(t,Tn,E=>n(34,d=E)),x(t,ft,E=>n(35,c=E)),x(t,mt,E=>n(11,f=E)),x(t,Ze,E=>n(12,h=E));let _,y,w,v=7,N=[.2,.3,.45,.6,.75,.85,.95,1,1.1,1.25,1.5,1.75,2,2.5,3,4,5],C=!1,T,S=new URLSearchParams(window.location.search).get("id");su(()=>{if(S)if(U($,r.load.ongoing=!0,r),!S.startsWith("-N"))U($,r.load.status=-1,r),U($,r.message="invalid_id",r);else{U($,r.load.status=0,r);let E=Wa(an(un,"builds"),qa()),oe=0;Fa(E).then(he=>{for(let Ae in he.val()){if(Ae==S){P(he.val()[Ae],Ae);break}else oe==Object.keys(he.val()).length-1&&(U($,r.load.status=-1,r),U($,r.message="invalid_id",r));oe++}}).catch(()=>{U($,r.load.status=-1,r),U($,r.message="firebase_fail",r)})}n(18,w=y>_),h[Object.keys(h)[0]]&&U(mt,f=!0,f)});function P(E,oe){for(let he in E.eq){let Ae=c[he]||ur;E.eq[he]&&E.eq[he]!=Ae.name?d[he][E.eq[he]].querySelector("button").click():!E.eq[he]&&Ae.name&&d[he][Ae.name].querySelector("button").click()}for(let he of Wn){let Ae=u[he]||cr;Ae.name&&l[he][Ae.name].querySelector("button").click()}setTimeout(()=>{for(let he of Wn)E.gear[he]&&l[he][E.gear[he]].querySelector("button").click();U($,r.load.ongoing=!1,r),U($,r.load.status=null,r),oe&&(U(Ke,i=E,i),U(Ke,i.id=oe,i),n(6,S=null))})}let I=[],W=[],ie,A,F=9;for(let E=0;E<F;E++)I.push(`backgrounds/BG${E}.jpg`);function R(E){A=Math.floor(Math.random()*E.length)}R(I);function K(){n(7,ie=A),W.push(A)}K(),function E(){setTimeout(()=>{if(R(I),!W.length)K();else if(W.length>3&&(W=W.slice(1)),!W.includes(A))K();else{let oe=[...Array(F).keys()].filter(he=>!W.includes(he));R(oe),K()}document.hasFocus&&E()},45e3)}();function Q(){T=setTimeout(()=>{n(5,C=!1)},2e3)}function k(){clearTimeout(T),n(5,C=!0),Q()}function Y(){U($,r.export.status=null,r),U($,r.export.ongoing=!1,r),U($,r.save.status=null,r),U($,r.save.ongoing=!1,r),U($,r.load.status=null,r),U($,r.load.ongoing=!1,r),U($,r.delete.status=null,r),U($,r.delete.ongoing=!1,r),U($,r.share.ongoing=!1,r),U($,r.message="",r)}let ee=!1;const j=E=>{if(E.key=="builds")if(E.url.includes("ls=true")){U(Ze,h=JSON.parse(E.newValue),h),U(mt,f=Object.keys(JSON.parse(E.newValue)).length>0,f),Y();let oe=Object.keys(JSON.parse(E.oldValue)).filter(he=>!Object.keys(JSON.parse(E.newValue)).includes(he))[0];oe&&i&&oe==i.name&&U(Ke,i=null,i)}else window.localStorage.setItem("builds",JSON.stringify(h))},te=E=>{let oe=E.wheelDeltaY;if(E.ctrlKey){if(E.preventDefault(),N[v]==.2&&oe<0||N[v]==5&&oe>0)return;oe>0?n(2,v++,v):n(2,v--,v),k()}},fe=E=>{E.ctrlKey&&(E.key=="-"||E.key=="+"||E.code=="Equal"||E.key=="0")&&(E.preventDefault(),(E.key=="+"||E.code=="Equal")&&N[v]!=5?n(2,v++,v):E.key=="-"&&N[v]!=.2?n(2,v--,v):E.key=="0"&&N[v]!=1&&n(2,v=7),k()),o&&o_(E)};function z(){n(0,_=Zt.outerHeight),n(1,y=Zt.outerWidth)}const b=()=>{o||U($,r.share.ongoing=!0,r)},O=()=>n(8,ee=!0),V=()=>n(8,ee=!1);function ne(E){S=E,n(6,S)}const Pe=E=>P(E.detail.build,E.detail.id);return t.$$.update=()=>{if(t.$$.dirty[0]&524291&&(y||_)&&(n(18,w=y>_),a))for(let E of a)dr(E.node,E.itemName);t.$$.dirty[0]&262148&&(w?document.documentElement.style.setProperty("--u",`${.75*N[v]}vh`):document.documentElement.style.setProperty("--u","0.75vh")),t.$$.dirty[0]&16&&n(9,s=r.export.status||r.save.status||r.load.status||r.delete.status),t.$$.dirty[0]&16&&U(In,o=r.export.ongoing||r.save.ongoing||r.load.ongoing||r.delete.ongoing||r.share.ongoing,o),t.$$.dirty[0]&8&&(document.title=(i?i.name+" - ":"")+"Fantastic Calculator")},[_,y,v,i,r,C,S,ie,ee,s,o,f,h,N,P,I,k,Y,w,a,j,te,fe,z,b,O,V,ne,Pe]}class $p extends Ne{constructor(e){super(),Te(this,e,Zp,Xp,de,{},null,[-1,-1])}}new $p({target:document.body});
