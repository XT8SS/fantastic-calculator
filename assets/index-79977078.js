 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ic={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},bt=new rl("app","Firebase",Ic);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nc=Cc;function cl(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:oi,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw bt.create("bad-app-name",{appName:String(i)});if(n||(n=nl()),!n)throw bt.create("no-options");const r=as.get(i);if(r){if(ni(n,r.options)&&ni(s,r.config))return r;throw bt.create("duplicate-app",{appName:i})}const o=new Mu(i);for(const a of li.values())o.addComponent(a);const l=new Tc(n,s,o);return as.set(i,l),l}function Dc(t=oi){const e=as.get(t);if(!e&&t===oi&&nl())return cl();if(!e)throw bt.create("no-app",{appName:t});return e}function tn(t,e,n){var s;let i=(s=Ec[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),qt.warn(l.join(" "));return}us(new Dn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oc="firebase-heartbeat-database",Rc=1,On="firebase-heartbeat-store";let Vs=null;function dl(){return Vs||(Vs=Ku(Oc,Rc,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(On)}}}).catch(t=>{throw bt.create("idb-open",{originalErrorMessage:t.message})})),Vs}async function Ac(t){try{return await(await dl()).transaction(On).objectStore(On).get(fl(t))}catch(e){if(e instanceof Hn)qt.warn(e.message);else{const n=bt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});qt.warn(n.message)}}}async function Er(t,e){try{const s=(await dl()).transaction(On,"readwrite");await s.objectStore(On).put(e,fl(t)),await s.done}catch(n){if(n instanceof Hn)qt.warn(n.message);else{const s=bt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});qt.warn(s.message)}}}function fl(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _l=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Uc(e)}}catch{}return new jc},Pt=_l("localStorage"),ai=_l("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nd{constructor(e,n){this.appName_=e,this.appCheckProvider=n,this.appCheck=n==null?void 0:n.getImmediate({optional:!0}),this.appCheck||n==null||n.get().then(s=>this.appCheck=s)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((n,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(n,s):n(null)},0)})}addTokenChangeListener(e){var n;(n=this.appCheckProvider)===null||n===void 0||n.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){xe(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fr=32,Wr=768;class Ce{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let s=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[s]=this.pieces_[i],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function me(){return new Ce("")}function ue(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function St(t){return t.pieces_.length-t.pieceNum_}function Se(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new Ce(t.pieces_,e)}function Bl(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function Dd(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function Fl(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function Wl(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new Ce(e,0)}function Be(t,e){const n=[];for(let s=t.pieceNum_;s<t.pieces_.length;s++)n.push(t.pieces_[s]);if(e instanceof Ce)for(let s=e.pieceNum_;s<e.pieces_.length;s++)n.push(e.pieces_[s]);else{const s=e.split("/");for(let i=0;i<s.length;i++)s[i].length>0&&n.push(s[i])}return new Ce(n,0)}function ae(t){return t.pieceNum_>=t.pieces_.length}function je(t,e){const n=ue(t),s=ue(e);if(n===null)return e;if(n===s)return je(Se(t),Se(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function ql(t,e){if(St(t)!==St(e))return!1;for(let n=t.pieceNum_,s=e.pieceNum_;n<=t.pieces_.length;n++,s++)if(t.pieces_[n]!==e.pieces_[s])return!1;return!0}function et(t,e){let n=t.pieceNum_,s=e.pieceNum_;if(St(t)>St(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[s])return!1;++n,++s}return!0}class Od{constructor(e,n){this.errorPrefix_=n,this.parts_=Fl(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=Is(this.parts_[s]);zl(this)}}function Rd(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=Is(e),zl(t)}function Ad(t){const e=t.parts_.pop();t.byteLength_-=Is(e),t.parts_.length>0&&(t.byteLength_-=1)}function zl(t){if(t.byteLength_>Wr)throw new Error(t.errorPrefix_+"has a key path longer than "+Wr+" bytes ("+t.byteLength_+").");if(t.parts_.length>Fr)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Fr+") or object contains a cycle "+At(t))}function At(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yd=!0;function qe(t,e=null){if(t===null)return se.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),q(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new Fe(n,qe(e))}if(!(t instanceof Array)&&Yd){const n=[];let s=!1;if(Xe(t,(o,l)=>{if(o.substring(0,1)!=="."){const a=qe(l);a.isEmpty()||(s=s||!a.getPriority().isEmpty(),n.push(new le(o,a)))}}),n.length===0)return se.EMPTY_NODE;const r=fs(n,Wd,o=>o.name,qi);if(s){const o=fs(n,Oe.getCompare());return new se(r,qe(e),new ct({".priority":o},{".priority":Oe}))}else return new se(r,qe(e),ct.Default)}else{let n=se.EMPTY_NODE;return Xe(t,(s,i)=>{if(at(t,s)&&s.substring(0,1)!=="."){const r=qe(i);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(s,r))}}),n.updatePriority(qe(e))}}zd(qe);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vr=10*1e3,tf=30*1e3,nf=5*60*1e3;class sf{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new ef(e);const s=Vr+(tf-Vr)*Math.random();wn(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Xe(e,(i,r)=>{r>0&&at(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),wn(this.reportStats_.bind(this),Math.floor(Math.random()*2*nf))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var tt;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(tt||(tt={}));function Xl(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Ui(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function ji(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ps{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=tt.ACK_USER_WRITE,this.source=Xl()}operationForChild(e){if(ae(this.path)){if(this.affectedTree.value!=null)return q(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new Ce(e));return new ps(me(),n,this.revert)}}else return q(ue(this.path)===e,"operationForChild called for unrelated child."),new ps(Se(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ns(t,e){return{eventCache:t,serverCache:e}}function Cn(t,e,n,s){return Ns(new kt(e,n,s),t.serverCache)}function Jl(t,e,n,s){return Ns(t.eventCache,new kt(e,n,s))}function ms(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Ut(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ds(t,e){return na(e,t)}function cf(t,e,n,s,i){q(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=En(t.visibleWrites,e,n)),t.lastWriteId=s}function df(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function ff(t,e){const n=t.allWrites.findIndex(l=>l.writeId===e);q(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const l=t.allWrites[o];l.visible&&(o>=n&&hf(l,s.path)?i=!1:et(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return _f(t),!0;if(s.snap)t.visibleWrites=Yr(t.visibleWrites,s.path);else{const l=s.children;Xe(l,a=>{t.visibleWrites=Yr(t.visibleWrites,Be(s.path,a))})}return!0}else return!1}function hf(t,e){if(t.snap)return et(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&et(Be(t.path,n),e))return!0;return!1}function _f(t){t.visibleWrites=$l(t.allWrites,pf,me()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function pf(t){return t.visible}function $l(t,e,n){let s=nt.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let l;if(r.snap)et(n,o)?(l=je(n,o),s=En(s,l,r.snap)):et(o,n)&&(l=je(o,n),s=En(s,me(),r.snap.getChild(l)));else if(r.children){if(et(n,o))l=je(n,o),s=Gr(s,l,r.children);else if(et(o,n))if(l=je(o,n),ae(l))s=Gr(s,me(),r.children);else{const a=rn(r.children,ue(l));if(a){const u=a.getChild(Se(l));s=En(s,me(),u)}}}else throw dn("WriteRecord should have .snap or .children")}}return s}function ea(t,e,n,s,i){if(!s&&!i){const r=Vt(t.visibleWrites,e);if(r!=null)return r;{const o=vt(t.visibleWrites,e);if(_i(o))return n;if(n==null&&!hi(o,me()))return null;{const l=n||se.EMPTY_NODE;return ln(o,l)}}}else{const r=vt(t.visibleWrites,e);if(!i&&_i(r))return n;if(!i&&n==null&&!hi(r,me()))return null;{const o=function(u){return(u.visible||i)&&(!s||!~s.indexOf(u.writeId))&&(et(u.path,e)||et(e,u.path))},l=$l(t.allWrites,o,e),a=n||se.EMPTY_NODE;return ln(l,a)}}}function mf(t,e,n){let s=se.EMPTY_NODE;const i=Vt(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(Oe,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=vt(t.visibleWrites,e);return n.forEachChild(Oe,(o,l)=>{const a=ln(vt(r,new Ce(o)),l);s=s.updateImmediateChild(o,a)}),Kr(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=vt(t.visibleWrites,e);return Kr(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function gf(t,e,n,s,i){q(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=Be(e,n);if(hi(t.visibleWrites,r))return null;{const o=vt(t.visibleWrites,r);return _i(o)?i.getChild(n):ln(o,i.getChild(n))}}function bf(t,e,n,s){const i=Be(e,n),r=Vt(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=vt(t.visibleWrites,i);return ln(o,s.getNode().getImmediateChild(n))}else return null}function yf(t,e){return Vt(t.visibleWrites,e)}function vf(t,e,n,s,i,r,o){let l;const a=vt(t.visibleWrites,e),u=Vt(a,me());if(u!=null)l=u;else if(n!=null)l=ln(a,n);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const d=[],c=o.getCompare(),f=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let h=f.getNext();for(;h&&d.length<i;)c(h,s)!==0&&d.push(h),h=f.getNext();return d}else return[]}function wf(){return{visibleWrites:nt.empty(),allWrites:[],lastWriteId:-1}}function gs(t,e,n,s){return ea(t.writeTree,t.treePath,e,n,s)}function Vi(t,e){return mf(t.writeTree,t.treePath,e)}function xr(t,e,n,s){return gf(t.writeTree,t.treePath,e,n,s)}function bs(t,e){return yf(t.writeTree,Be(t.treePath,e))}function Cf(t,e,n,s,i,r){return vf(t.writeTree,t.treePath,e,n,s,i,r)}function Gi(t,e,n){return bf(t.writeTree,t.treePath,e,n)}function ta(t,e){return na(Be(t.treePath,e),t.writeTree)}function na(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sf{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const sa=new Sf;class Yi{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new kt(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Gi(this.writes_,e,s)}}getChildAfterChild(e,n,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Ut(this.viewCache_),r=Cf(this.writes_,i,n,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vs;class oa{constructor(){this.views=new Map}}function qf(t){q(!vs,"__referenceConstructor has already been defined"),vs=t}function zf(){return q(vs,"Reference.ts has not been loaded"),vs}function Hf(t){return t.views.size===0}function Ki(t,e,n,s){const i=e.source.queryId;if(i!==null){const r=t.views.get(i);return q(r!=null,"SyncTree gave us an op for an invalid query."),$r(r,e,n,s)}else{let r=[];for(const o of t.views.values())r=r.concat($r(o,e,n,s));return r}}function la(t,e,n,s,i){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let l=gs(n,i?s:null),a=!1;l?a=!0:s instanceof se?(l=Vi(n,s),a=!1):(l=se.EMPTY_NODE,a=!1);const u=Ns(new kt(l,a,!1),new kt(s,i,!1));return new Pf(e,u)}return o}function Uf(t,e,n,s,i,r){const o=la(t,e,s,i,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),Ff(o,n),Wf(o,n)}function jf(t,e,n,s){const i=e._queryIdentifier,r=[];let o=[];const l=It(t);if(i==="default")for(const[a,u]of t.views.entries())o=o.concat(Zr(u,n,s)),Jr(u)&&(t.views.delete(a),u.query._queryParams.loadsAllData()||r.push(u.query));else{const a=t.views.get(i);a&&(o=o.concat(Zr(a,n,s)),Jr(a)&&(t.views.delete(i),a.query._queryParams.loadsAllData()||r.push(a.query)))}return l&&!It(t)&&r.push(new(zf())(e._repo,e._path)),{removed:r,events:o}}function aa(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function wt(t,e){let n=null;for(const s of t.views.values())n=n||Bf(s,e);return n}function ua(t,e){if(e._queryParams.loadsAllData())return Os(t);{const s=e._queryIdentifier;return t.views.get(s)}}function ca(t,e){return ua(t,e)!=null}function It(t){return Os(t)!=null}function Os(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ws;function Vf(t){q(!ws,"__referenceConstructor has already been defined"),ws=t}function Gf(){return q(ws,"Reference.ts has not been loaded"),ws}let Yf=1;class eo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Ie(null),this.pendingWriteTree_=wf(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function da(t,e,n,s,i){return cf(t.pendingWriteTree_,e,n,s,i),i?Yn(t,new Ht(Xl(),e,n)):[]}function Mt(t,e,n=!1){const s=df(t.pendingWriteTree_,e);if(ff(t.pendingWriteTree_,e)){let r=new Ie(null);return s.snap!=null?r=r.set(me(),!0):Xe(s.children,o=>{r=r.set(new Ce(o),!0)}),Yn(t,new ps(s.path,r,n))}else return[]}function Gn(t,e,n){return Yn(t,new Ht(Ui(),e,n))}function Kf(t,e,n){const s=Ie.fromObject(n);return Yn(t,new Bn(Ui(),e,s))}function xf(t,e){return Yn(t,new Ln(Ui(),e))}function Qf(t,e,n){const s=Qi(t,n);if(s){const i=Xi(s),r=i.path,o=i.queryId,l=je(r,e),a=new Ln(ji(o),l);return Ji(t,r,a)}else return[]}function fa(t,e,n,s,i=!1){const r=e._path,o=t.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||ca(o,e))){const a=jf(o,e,n,s);Hf(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const u=a.removed;if(l=a.events,!i){const d=u.findIndex(f=>f._queryParams.loadsAllData())!==-1,c=t.syncPointTree_.findOnPath(r,(f,h)=>It(h));if(d&&!c){const f=t.syncPointTree_.subtree(r);if(!f.isEmpty()){const h=$f(f);for(let p=0;p<h.length;++p){const b=h[p],v=b.query,y=ma(t,b);t.listenProvider_.startListening(Sn(v),Fn(t,v),y.hashFn,y.onComplete)}}}!c&&u.length>0&&!s&&(d?t.listenProvider_.stopListening(Sn(e),null):u.forEach(f=>{const h=t.queryToTagMap.get(Rs(f));t.listenProvider_.stopListening(Sn(f),h)}))}eh(t,u)}return l}function ha(t,e,n,s){const i=Qi(t,s);if(i!=null){const r=Xi(i),o=r.path,l=r.queryId,a=je(o,e),u=new Ht(ji(l),a,n);return Ji(t,o,u)}else return[]}function Xf(t,e,n,s){const i=Qi(t,s);if(i){const r=Xi(i),o=r.path,l=r.queryId,a=je(o,e),u=Ie.fromObject(n),d=new Bn(ji(l),a,u);return Ji(t,o,d)}else return[]}function Jf(t,e,n,s=!1){const i=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(i,(f,h)=>{const p=je(f,i);r=r||wt(h,p),o=o||It(h)});let l=t.syncPointTree_.get(i);l?(o=o||It(l),r=r||wt(l,me())):(l=new oa,t.syncPointTree_=t.syncPointTree_.set(i,l));let a;r!=null?a=!0:(a=!1,r=se.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((h,p)=>{const b=wt(p,me());b&&(r=r.updateImmediateChild(h,b))}));const u=ca(l,e);if(!u&&!e._queryParams.loadsAllData()){const f=Rs(e);q(!t.queryToTagMap.has(f),"View does not exist, but we have a tag");const h=th();t.queryToTagMap.set(f,h),t.tagToQueryMap.set(h,f)}const d=Ds(t.pendingWriteTree_,i);let c=Uf(l,e,n,d,r,a);if(!u&&!o&&!s){const f=ua(l,e);c=c.concat(nh(t,e,f))}return c}function xi(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=je(o,e),u=wt(l,a);if(u)return u});return ea(i,e,r,n,!0)}function Zf(t,e){const n=e._path;let s=null;t.syncPointTree_.foreachOnPath(n,(u,d)=>{const c=je(u,n);s=s||wt(d,c)});let i=t.syncPointTree_.get(n);i?s=s||wt(i,me()):(i=new oa,t.syncPointTree_=t.syncPointTree_.set(n,i));const r=s!=null,o=r?new kt(s,!0,!1):null,l=Ds(t.pendingWriteTree_,e._path),a=la(i,e,l,r?o.getNode():se.EMPTY_NODE,r);return Lf(a)}function Yn(t,e){return _a(e,t.syncPointTree_,null,Ds(t.pendingWriteTree_,me()))}function _a(t,e,n,s){if(ae(t.path))return pa(t,e,n,s);{const i=e.get(me());n==null&&i!=null&&(n=wt(i,me()));let r=[];const o=ue(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const u=n?n.getImmediateChild(o):null,d=ta(s,o);r=r.concat(_a(l,a,u,d))}return i&&(r=r.concat(Ki(i,t,s,n))),r}}function pa(t,e,n,s){const i=e.get(me());n==null&&i!=null&&(n=wt(i,me()));let r=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,u=ta(s,o),d=t.operationForChild(o);d&&(r=r.concat(pa(d,l,a,u)))}),i&&(r=r.concat(Ki(i,t,s,n))),r}function ma(t,e){const n=e.query,s=Fn(t,n);return{hashFn:()=>(Mf(e)||se.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Qf(t,n._path,s):xf(t,n._path);{const r=Jc(i,n);return fa(t,n,null,r)}}}}function Fn(t,e){const n=Rs(e);return t.queryToTagMap.get(n)}function Rs(t){return t._path.toString()+"$"+t._queryIdentifier}function Qi(t,e){return t.tagToQueryMap.get(e)}function Xi(t){const e=t.indexOf("$");return q(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new Ce(t.substr(0,e))}}function Ji(t,e,n){const s=t.syncPointTree_.get(e);q(s,"Missing sync point for query tag that we're tracking");const i=Ds(t.pendingWriteTree_,e);return Ki(s,n,i,null)}function $f(t){return t.fold((e,n,s)=>{if(n&&It(n))return[Os(n)];{let i=[];return n&&(i=aa(n)),Xe(s,(r,o)=>{i=i.concat(o)}),i}})}function Sn(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(Gf())(t._repo,t._path):t}function eh(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const i=Rs(s),r=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(r)}}}function th(){return Yf++}function nh(t,e,n){const s=e._path,i=Fn(t,e),r=ma(t,n),o=t.listenProvider_.startListening(Sn(e),i,r.hashFn,r.onComplete),l=t.syncPointTree_.subtree(s);if(i)q(!It(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((u,d,c)=>{if(!ae(u)&&d&&It(d))return[Os(d).query];{let f=[];return d&&(f=f.concat(aa(d).map(h=>h.query))),Xe(c,(h,p)=>{f=f.concat(p)}),f}});for(let u=0;u<a.length;++u){const d=a[u];t.listenProvider_.stopListening(Sn(d),Fn(t,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
