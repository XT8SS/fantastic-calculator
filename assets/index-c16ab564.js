 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _d{constructor(e,t){this.appName_=e,this.appCheckProvider=t,this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(s=>this.appCheck=s)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((t,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){et(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class is{constructor(e,t,s,i,o=null){this.isReverse_=i,this.resultGenerator_=o,this.nodeStack_=[];let r=1;for(;!e.isEmpty();)if(e=e,r=t?s(e.key,t):1,i&&(r*=-1),r<0)this.isReverse_?e=e.left:e=e.right;else if(r===0){this.nodeStack_.push(e);break}else this.nodeStack_.push(e),this.isReverse_?e=e.right:e=e.left}getNext(){if(this.nodeStack_.length===0)return null;let e=this.nodeStack_.pop(),t;if(this.resultGenerator_?t=this.resultGenerator_(e.key,e.value):t={key:e.key,value:e.value},this.isReverse_)for(e=e.left;!e.isEmpty();)this.nodeStack_.push(e),e=e.right;else for(e=e.right;!e.isEmpty();)this.nodeStack_.push(e),e=e.left;return t}hasNext(){return this.nodeStack_.length>0}peek(){if(this.nodeStack_.length===0)return null;const e=this.nodeStack_[this.nodeStack_.length-1];return this.resultGenerator_?this.resultGenerator_(e.key,e.value):{key:e.key,value:e.value}}}class ze{constructor(e,t,s,i,o){this.key=e,this.value=t,this.color=s??ze.RED,this.left=i??$e.EMPTY_NODE,this.right=o??$e.EMPTY_NODE}copy(e,t,s,i,o){return new ze(e??this.key,t??this.value,s??this.color,i??this.left,o??this.right)}count(){return this.left.count()+1+this.right.count()}isEmpty(){return!1}inorderTraversal(e){return this.left.inorderTraversal(e)||!!e(this.key,this.value)||this.right.inorderTraversal(e)}reverseTraversal(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)}min_(){return this.left.isEmpty()?this:this.left.min_()}minKey(){return this.min_().key}maxKey(){return this.right.isEmpty()?this.key:this.right.maxKey()}insert(e,t,s){let i=this;const o=s(e,i.key);return o<0?i=i.copy(null,null,null,i.left.insert(e,t,s),null):o===0?i=i.copy(null,t,null,null,null):i=i.copy(null,null,null,null,i.right.insert(e,t,s)),i.fixUp_()}removeMin_(){if(this.left.isEmpty())return $e.EMPTY_NODE;let e=this;return!e.left.isRed_()&&!e.left.left.isRed_()&&(e=e.moveRedLeft_()),e=e.copy(null,null,null,e.left.removeMin_(),null),e.fixUp_()}remove(e,t){let s,i;if(s=this,t(e,s.key)<0)!s.left.isEmpty()&&!s.left.isRed_()&&!s.left.left.isRed_()&&(s=s.moveRedLeft_()),s=s.copy(null,null,null,s.left.remove(e,t),null);else{if(s.left.isRed_()&&(s=s.rotateRight_()),!s.right.isEmpty()&&!s.right.isRed_()&&!s.right.left.isRed_()&&(s=s.moveRedRight_()),t(e,s.key)===0){if(s.right.isEmpty())return $e.EMPTY_NODE;i=s.right.min_(),s=s.copy(i.key,i.value,null,null,s.right.removeMin_())}s=s.copy(null,null,null,null,s.right.remove(e,t))}return s.fixUp_()}isRed_(){return this.color}fixUp_(){let e=this;return e.right.isRed_()&&!e.left.isRed_()&&(e=e.rotateLeft_()),e.left.isRed_()&&e.left.left.isRed_()&&(e=e.rotateRight_()),e.left.isRed_()&&e.right.isRed_()&&(e=e.colorFlip_()),e}moveRedLeft_(){let e=this.colorFlip_();return e.right.left.isRed_()&&(e=e.copy(null,null,null,null,e.right.rotateRight_()),e=e.rotateLeft_(),e=e.colorFlip_()),e}moveRedRight_(){let e=this.colorFlip_();return e.left.left.isRed_()&&(e=e.rotateRight_(),e=e.colorFlip_()),e}rotateLeft_(){const e=this.copy(null,null,ze.RED,null,this.right.left);return this.right.copy(null,null,this.color,e,null)}rotateRight_(){const e=this.copy(null,null,ze.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,e)}colorFlip_(){const e=this.left.copy(null,null,!this.left.color,null,null),t=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,t)}checkMaxDepth_(){const e=this.check_();return Math.pow(2,e)<=this.count()+1}check_(){if(this.isRed_()&&this.left.isRed_())throw new Error("Red node has red child("+this.key+","+this.value+")");if(this.right.isRed_())throw new Error("Right child of ("+this.key+","+this.value+") is red");const e=this.left.check_();if(e!==this.right.check_())throw new Error("Black depths differ");return e+(this.isRed_()?0:1)}}ze.RED=!0;ze.BLACK=!1;class Xd{copy(e,t,s,i,o){return this}insert(e,t,s){return new ze(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}}class $e{constructor(e,t=$e.EMPTY_NODE){this.comparator_=e,this.root_=t}insert(e,t){return new $e(this.comparator_,this.root_.insert(e,t,this.comparator_).copy(null,null,ze.BLACK,null,null))}remove(e){return new $e(this.comparator_,this.root_.remove(e,this.comparator_).copy(null,null,ze.BLACK,null,null))}get(e){let t,s=this.root_;for(;!s.isEmpty();){if(t=this.comparator_(e,s.key),t===0)return s.value;t<0?s=s.left:t>0&&(s=s.right)}return null}getPredecessorKey(e){let t,s=this.root_,i=null;for(;!s.isEmpty();)if(t=this.comparator_(e,s.key),t===0){if(s.left.isEmpty())return i?i.key:null;for(s=s.left;!s.right.isEmpty();)s=s.right;return s.key}else t<0?s=s.left:t>0&&(i=s,s=s.right);throw new Error("Attempted to find predecessor key for a nonexistent key.  What gives?")}isEmpty(){return this.root_.isEmpty()}count(){return this.root_.count()}minKey(){return this.root_.minKey()}maxKey(){return this.root_.maxKey()}inorderTraversal(e){return this.root_.inorderTraversal(e)}reverseTraversal(e){return this.root_.reverseTraversal(e)}getIterator(e){return new is(this.root_,null,this.comparator_,!1,e)}getIteratorFrom(e,t){return new is(this.root_,e,this.comparator_,!1,t)}getReverseIteratorFrom(e,t){return new is(this.root_,e,this.comparator_,!0,t)}getReverseIterator(e){return new is(this.root_,null,this.comparator_,!0,e)}}$e.EMPTY_NODE=new Xd;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of=!0;function Ue(n,e=null){if(n===null)return oe.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),z(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new He(t,Ue(e))}if(!(n instanceof Array)&&of){const t=[];let s=!1;if(tt(n,(r,a)=>{if(r.substring(0,1)!=="."){const l=Ue(a);l.isEmpty()||(s=s||!l.getPriority().isEmpty(),t.push(new ce(r,l)))}}),t.length===0)return oe.EMPTY_NODE;const o=bs(t,xd,r=>r.name,Ui);if(s){const r=bs(t,Me.getCompare());return new oe(o,Ue(e),new pt({".priority":r},{".priority":Me}))}else return new oe(o,Ue(e),pt.Default)}else{let t=oe.EMPTY_NODE;return tt(n,(s,i)=>{if(_t(n,s)&&s.substring(0,1)!=="."){const o=Ue(i);(o.isLeafNode()||!o.isEmpty())&&(t=t.updateImmediateChild(s,o))}}),t.updatePriority(Ue(e))}}Zd(Ue);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hf{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&tt(this.last_,(s,i)=>{t[s]=t[s]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xo=10*1e3,_f=30*1e3,pf=5*60*1e3;class mf{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new hf(e);const s=xo+(_f-xo)*Math.random();Dn(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;tt(e,(i,o)=>{o>0&&_t(this.statsToReport_,i)&&(t[i]=o,s=!0)}),s&&this.server_.reportStats(t),Dn(this.reportStats_.bind(this),Math.floor(Math.random()*2*pf))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
    ...
    <iconify-icon icon="iconamoon:arrow-down-2-fill" rotate="180deg" class="svelte-l9dczq"></iconify-icon>`,t=A(),pe(s.$$.fragment),g(e,"class","svelte-l9dczq"),J(e,"ddOpen",n[0])},m(d,c){F(d,e,c),F(d,t,c),fe(s,d,c),o=!0,r||(a=N(e,"click",n[1]),r=!0)},p(d,[c]){(!o||c&1)&&J(e,"ddOpen",d[0]);const f={};!i&&c&1&&(i=!0,f.slotOpen=d[0],Ee(()=>i=!1)),s.$set(f)},i(d){o||(W(s.$$.fragment,d),o=!0)},o(d){G(s.$$.fragment,d),o=!1},d(d){d&&(P(e),P(t)),he(s,d),r=!1,a()}}}function fp(n,e,t){let{ddOpen:s=!1}=e;const i=()=>t(0,s=!s);function o(r){s=r,t(0,s)}return n.$$set=r=>{"ddOpen"in r&&t(0,s=r.ddOpen)},[s,i,o]}class hp extends De{constructor(e){super(),Ne(this,e,fp,dp,me,{ddOpen:0})}}function _p(n){let e;return{c(){e=v("span"),e.textContent="Create some builds to get started!",g(e,"class","tooltip svelte-1c244fb"),g(e,"id","top"),Pe(e,"left","70.5%")},m(t,s){F(t,e,s)},p:te,d(t){t&&P(e)}}}function pp(n){let e;return{c(){e=v("span"),e.textContent="Select some gear or armor to get started!",g(e,"class","tooltip svelte-1c244fb"),g(e,"id","top"),Pe(e,"left",n[3]?"38%":"")},m(t,s){F(t,e,s)},p(t,s){s&8&&Pe(e,"left",t[3]?"38%":"")},d(t){t&&P(e)}}}function mp(n){let e,t,s,i,o,r,a,l,u,d,c,f,h,_,m,y,w,T,b,I,C,O,L,U,V,D,B,R;function re(X,Q){if(!X[4])return pp;if(!X[3])return _p}let ne=re(n),E=ne&&ne(n);function x(X){n[18](X)}let le={};return n[1]!==void 0&&(le.ddOpen=n[1]),U=new hp({props:le}),$.push(()=>ke(U,"ddOpen",x)),{c(){e=v("div"),t=v("div"),s=v("div"),i=v("button"),o=se("Export new build"),a=A(),l=v("div"),u=v("button"),d=se("Save to build"),f=A(),h=v("div"),_=v("button"),m=se("Delete build"),w=A(),E&&E.c(),T=A(),b=v("div"),I=v("div"),C=v("button"),C.textContent="Load build",O=A(),L=v("div"),pe(U.$$.fragment),i.disabled=r=!n[4],g(i,"class","svelte-1c244fb"),g(s,"class","buttonCont svelte-1c244fb"),u.disabled=c=!n[4]||!n[3],g(u,"class","svelte-1c244fb"),g(l,"class","buttonCont svelte-1c244fb"),g(l,"id","middle"),_.disabled=y=!n[3],g(_,"class","svelte-1c244fb"),g(h,"class","buttonCont svelte-1c244fb"),g(t,"id","modify"),g(t,"class","svelte-1c244fb"),J(t,"no-tooltip",n[2]),g(C,"class","svelte-1c244fb"),g(I,"class","buttonCont svelte-1c244fb"),g(L,"class","buttonCont svelte-1c244fb"),g(b,"id","load"),g(b,"class","svelte-1c244fb"),g(e,"class","mainFeatures svelte-1c244fb"),g(e,"id","build")},m(X,Q){F(X,e,Q),p(e,t),p(t,s),p(s,i),p(i,o),p(t,a),p(t,l),p(l,u),p(u,d),p(t,f),p(t,h),p(h,_),p(_,m),p(t,w),E&&E.m(t,null),p(e,T),p(e,b),p(b,I),p(I,C),p(b,O),p(b,L),fe(U,L,null),n[19](L),D=!0,B||(R=[N(window,"mousedown",n[8]),N(window,"keydown",n[9]),N(i,"click",n[10]),N(i,"mouseenter",n[11]),N(i,"mouseleave",n[12]),N(u,"click",n[13]),N(_,"click",n[14]),N(_,"mouseenter",n[15]),N(_,"mouseleave",n[16]),N(C,"click",n[17])],B=!0)},p(X,[Q]){(!D||Q&16&&r!==(r=!X[4]))&&(i.disabled=r),(!D||Q&24&&c!==(c=!X[4]||!X[3]))&&(u.disabled=c),(!D||Q&8&&y!==(y=!X[3]))&&(_.disabled=y),ne===(ne=re(X))&&E?E.p(X,Q):(E&&E.d(1),E=ne&&ne(X),E&&(E.c(),E.m(t,null))),(!D||Q&4)&&J(t,"no-tooltip",X[2]);const ae={};!V&&Q&2&&(V=!0,ae.ddOpen=X[1],Ee(()=>V=!1)),U.$set(ae)},i(X){D||(W(U.$$.fragment,X),D=!0)},o(X){G(U.$$.fragment,X),D=!1},d(X){X&&P(e),E&&E.d(),he(U),n[19](null),B=!1,ge(R)}}}function gp(n,e,t){let s,i,o,r,a;K(n,nt,L=>t(7,s=L)),K(n,kt,L=>t(3,i=L)),K(n,ul,L=>t(4,o=L)),K(n,dn,L=>t(5,r=L)),K(n,Z,L=>t(6,a=L));let l,u=!1,d=!1;const c=L=>{l.contains(L.target)||t(1,u=!1)},f=L=>{L.key=="Escape"&&t(1,u=!1)},h=()=>{o&&!r&&j(Z,a.export.ongoing=!0,a)},_=()=>t(2,d=!0),m=()=>t(2,d=!1),y=()=>{o&&i&&!r&&j(Z,a.save.ongoing=!0,a)},w=()=>{i&&!r&&j(Z,a.delete.ongoing=!0,a)},T=()=>t(2,d=!0),b=()=>t(2,d=!1),I=()=>{r||j(Z,a.load.ongoing=!0,a)};function C(L){u=L,t(1,u)}function O(L){$[L?"unshift":"push"](()=>{l=L,t(0,l)})}return n.$$.update=()=>{n.$$.dirty&128&&j(kt,i=Object.keys(s).length>0,i)},[l,u,d,i,o,r,a,s,c,f,h,_,m,y,w,T,b,I,C,O]}class bp extends De{constructor(e){super(),Ne(this,e,gp,mp,me,{})}}function Lr(n){let e;return{c(){e=v("span"),e.textContent="New changes! Exiting will erase them.",g(e,"id","alert")},m(t,s){F(t,e,s)},d(t){t&&P(e)}}}function yp(n){let e,t,s,i,o,r,a,l=25-n[3].length+"",u,d,c,f,h,_,m,y,w,T,b,I=275-n[4].length+"",C,O,L,U,V,D,B,R,re,ne,E,x,le,X,Q,ae,k=(n[3]||n[4])&&Lr();return{c(){e=v("div"),t=v("div"),s=se(`Name:\r
        `),i=v("input"),r=A(),a=v("span"),u=se(l),d=A(),c=v("div"),f=v("div"),h=v("span"),h.textContent="Description / Notes:",_=A(),k&&k.c(),m=A(),y=v("textarea"),T=A(),b=v("span"),C=se(I),O=A(),L=v("div"),U=v("div"),V=v("button"),D=se("CANCEL"),R=A(),re=v("div"),ne=v("button"),E=se("EXPORT"),g(i,"class","buildNameInput"),g(i,"id","firstFocusable"),i.disabled=o=n[5].export.status==0,g(i,"type","text"),g(i,"placeholder",n[6]),g(i,"maxlength","25"),g(a,"class","charCounter svelte-1vypdkl"),g(a,"id","buildName"),g(t,"class","buildNameCont svelte-1vypdkl"),g(y,"class","buildDescInput"),y.disabled=w=n[5].export.status==0,g(y,"placeholder","[Empty]"),g(y,"maxlength","275"),g(y,"autocomplete","off"),g(b,"class","charCounter"),g(b,"id","buildDesc"),g(c,"class","buildDescCont"),V.disabled=B=n[5].export.status==0,g(ne,"id","lastFocusable"),ne.disabled=x=n[5].export.status==0,g(L,"class","promptOptions"),g(e,"class","buildExporter svelte-1vypdkl")},m(Y,q){F(Y,e,q),p(e,t),p(t,s),p(t,i),n[8](i),ct(i,n[3]),p(t,r),p(t,a),p(a,u),p(e,d),p(e,c),p(c,f),p(f,h),p(f,_),k&&k.m(f,null),p(c,m),p(c,y),ct(y,n[4]),n[13](y),p(c,T),p(c,b),p(b,C),p(e,O),p(e,L),p(L,U),p(U,V),p(V,D),n[16](V),p(L,R),p(L,re),p(re,ne),p(ne,E),X=!0,Q||(ae=[N(i,"input",n[9]),N(i,"input",n[10]),N(i,"keydown",n[11]),N(y,"input",n[12]),N(y,"input",n[14]),N(y,"keydown",n[15]),N(V,"click",n[17]),N(ne,"click",n[18]),N(ne,"keydown",Jt),N(e,"introstart",n[19])],Q=!0)},p(Y,[q]){(!X||q&32&&o!==(o=Y[5].export.status==0))&&(i.disabled=o),q&8&&i.value!==Y[3]&&ct(i,Y[3]),(!X||q&8)&&l!==(l=25-Y[3].length+"")&&Re(u,l),Y[3]||Y[4]?k||(k=Lr(),k.c(),k.m(f,null)):k&&(k.d(1),k=null),(!X||q&32&&w!==(w=Y[5].export.status==0))&&(y.disabled=w),q&16&&ct(y,Y[4]),(!X||q&16)&&I!==(I=275-Y[4].length+"")&&Re(C,I),(!X||q&32&&B!==(B=Y[5].export.status==0))&&(V.disabled=B),(!X||q&32&&x!==(x=Y[5].export.status==0))&&(ne.disabled=x)},i(Y){X||(Y&&ve(()=>{X&&(le||(le=Ae(e,st,{duration:250},!0)),le.run(1))}),X=!0)},o(Y){Y&&(le||(le=Ae(e,st,{duration:250},!1)),le.run(0)),X=!1},d(Y){Y&&P(e),n[8](null),k&&k.d(),n[13](null),n[16](null),Y&&le&&le.end(),Q=!1,ge(ae)}}}function vp(n,e,t){let s,i,o,r,a,l;K(n,Z,E=>t(5,s=E)),K(n,Ze,E=>t(20,i=E)),K(n,kt,E=>t(21,o=E)),K(n,Rt,E=>t(22,r=E)),K(n,bt,E=>t(23,a=E)),K(n,nt,E=>t(24,l=E));let u=Object.keys(l).length,d=(u+1)%10,c=d==1?"st":d==2?"nd":d==3?"rd":"th",f,h,_,m="",y="",w=`My ${u+1+c} build`;function T(){if(j(Z,s.export.status=0,s),m.endsWith(" ")&&t(3,m=m.replace(/  +/g," ").replace(/ $/,"")),y.endsWith(" ")&&t(4,y=y.replace(/  +/g," ").replace(/ $/,"")),Object.keys(l).includes(m)){j(Z,s.export.status=-1,s),j(Z,s.message="duplicate_name",s);return}let E=Jh(vt(pn(mn),"builds")).key,x=Ja(a,r);x.name=m||w,x.desc=y||"[Empty]",js(vt(pn(mn),`builds/${E}`),x).then(()=>{j(Z,s.export.status=1,s),j(kt,o=!0,o),mo(),nt.update(le=>({...le,[x.name]:{id:E,desc:x.desc}})),j(Ze,i=x,i),j(Ze,i.id=E,i),navigator.clipboard.writeText(`${location.origin+location.pathname}?id=${E}`)}).catch(()=>{j(Z,s.export.status=-1,s),j(Z,s.message="firebase_fail",s)})}function b(E){$[E?"unshift":"push"](()=>{f=E,t(0,f)})}function I(){m=this.value,t(3,m)}const C=E=>{t(3,m=Os(E.target.value,25))},O=E=>{s.export.status==0&&E.preventDefault(),Ft(E),Ii(f,E.target.value,25)};function L(){y=this.value,t(4,y)}function U(E){$[E?"unshift":"push"](()=>{h=E,t(1,h)})}const V=E=>{t(4,y=Os(E.target.value,275))},D=E=>{s.export.status==0&&E.preventDefault(),Ii(h,E.target.value,275)};function B(E){$[E?"unshift":"push"](()=>{_=E,t(2,_)})}return[f,h,_,m,y,s,w,T,b,I,C,O,L,U,V,D,B,()=>{s.export.status!=0&&j(Z,s.export.ongoing=!1,s)},()=>{s.export.status!=0&&T()},()=>_.focus()]}class wp extends De{constructor(e){super(),Ne(this,e,vp,yp,me,{})}}function Cp(n){let e,t,s,i,o=n[2]?"Copied!":"Copy link",r,a,l;return{c(){e=v("button"),t=v("b"),t.textContent="Build link",s=A(),i=v("span"),r=se(o),g(i,"class","tooltip svelte-zqs0fu"),g(i,"id","top"),g(e,"class","copyButton svelte-zqs0fu"),g(e,"id","firstFocusable")},m(u,d){F(u,e,d),p(e,t),p(e,s),p(e,i),p(i,r),a||(l=[N(e,"click",n[7]),N(e,"keydown",Ft)],a=!0)},p(u,d){d&4&&o!==(o=u[2]?"Copied!":"Copy link")&&Re(r,o)},d(u){u&&P(e),a=!1,ge(l)}}}function Ep(n){let e,t,s,i,o,r,a=n[2]?"Copied!":"Copy ID",l,u,d,c;return{c(){e=v("button"),t=v("b"),t.textContent="ID:",s=A(),i=se(n[4]),o=A(),r=v("span"),l=se(a),g(r,"class","tooltip svelte-zqs0fu"),g(r,"id","top"),g(e,"class","copyButton svelte-zqs0fu"),g(e,"id",u=n[1]!="save"?"firstFocusable":"")},m(f,h){F(f,e,h),p(e,t),p(e,s),p(e,i),p(e,o),p(e,r),p(r,l),d||(c=[N(e,"click",n[5]),N(e,"keydown",n[6])],d=!0)},p(f,h){h&4&&a!==(a=f[2]?"Copied!":"Copy ID")&&Re(l,a),h&2&&u!==(u=f[1]!="save"?"firstFocusable":"")&&g(e,"id",u)},d(f){f&&P(e),d=!1,ge(c)}}}function kp(n){let e;function t(o,r){if(o[0]=="id")return Ep;if(o[0]=="link")return Cp}let s=t(n),i=s&&s(n);return{c(){i&&i.c(),e=Gt()},m(o,r){i&&i.m(o,r),F(o,e,r)},p(o,[r]){s===(s=t(o))&&i?i.p(o,r):(i&&i.d(1),i=s&&s(o),i&&(i.c(),i.m(e.parentNode,e)))},i:te,o:te,d(o){o&&P(e),i&&i.d(o)}}}function Sp(n,e,t){let s;K(n,Ze,f=>t(8,s=f));let{type:i,source:o}=e,r=!1;function a(f){r||(navigator.clipboard.writeText(f),t(2,r=!0),setTimeout(()=>{t(2,r=!1)},1e3))}let l=s?s.id:null;const u=()=>a(l),d=()=>{o!="save"&&Ft()},c=()=>a(`${location.host+location.pathname}?id=${l}`);return n.$$set=f=>{"type"in f&&t(0,i=f.type),"source"in f&&t(1,o=f.source)},[i,o,r,a,l,u,d,c]}class Kn extends De{constructor(e){super(),Ne(this,e,Sp,kp,me,{type:0,source:1})}}function Ip(n){let e,t,s,i;return e=new Kn({props:{type:"link",source:"share"}}),s=new Kn({props:{type:"id",source:"share"}}),{c(){pe(e.$$.fragment),t=A(),pe(s.$$.fragment)},m(o,r){fe(e,o,r),F(o,t,r),fe(s,o,r),i=!0},p:te,i(o){i||(W(e.$$.fragment,o),W(s.$$.fragment,o),i=!0)},o(o){G(e.$$.fragment,o),G(s.$$.fragment,o),i=!1},d(o){o&&P(t),he(e,o),he(s,o)}}}function Tp(n){let e;return{c(){e=v("span"),e.textContent="Your build has been erased from your local saves and the database."},m(t,s){F(t,e,s)},p:te,i:te,o:te,d(t){t&&P(e)}}}function Np(n){let e;function t(o,r){if(o[2].message=="not_found")return Pp;if(o[2].message=="invalid_id")return Ap}let s=t(n),i=s&&s(n);return{c(){i&&i.c(),e=Gt()},m(o,r){i&&i.m(o,r),F(o,e,r)},p(o,r){s!==(s=t(o))&&(i&&i.d(1),i=s&&s(o),i&&(i.c(),i.m(e.parentNode,e)))},i:te,o:te,d(o){o&&P(e),i&&i.d(o)}}}function Dp(n){let e,t,s,i,o,r;return s=new Kn({props:{type:"link",source:"save"}}),o=new Kn({props:{type:"id",source:"save"}}),{c(){e=v("span"),e.textContent="Your build has been overwritten.",t=A(),pe(s.$$.fragment),i=A(),pe(o.$$.fragment)},m(a,l){F(a,e,l),F(a,t,l),fe(s,a,l),F(a,i,l),fe(o,a,l),r=!0},p:te,i(a){r||(W(s.$$.fragment,a),W(o.$$.fragment,a),r=!0)},o(a){G(s.$$.fragment,a),G(o.$$.fragment,a),r=!1},d(a){a&&(P(e),P(t),P(i)),he(s,a),he(o,a)}}}function Op(n){let e,t,s,i;const o=[Lp,Mp],r=[];function a(l,u){return l[2].export.status==1?0:l[2].export.status==-1&&l[2].message=="duplicate_name"?1:-1}return~(e=a(n))&&(t=r[e]=o[e](n)),{c(){t&&t.c(),s=Gt()},m(l,u){~e&&r[e].m(l,u),F(l,s,u),i=!0},p(l,u){let d=e;e=a(l),e!==d&&(t&&(Le(),G(r[d],1,1,()=>{r[d]=null}),Be()),~e?(t=r[e],t||(t=r[e]=o[e](l),t.c()),W(t,1),t.m(s.parentNode,s)):t=null)},i(l){i||(W(t),i=!0)},o(l){G(t),i=!1},d(l){l&&P(s),~e&&r[e].d(l)}}}function Rp(n){let e,t,s=n[2].export.status?"exporting":n[2].save.status?"saving":n[2].load.status?"loading":"deleting",i,o,r,a,l,u,d,c;return{c(){e=v("span"),t=se("A problem occurred while "),i=se(s),o=se(` your build.\r
            ...
            .backgrounds > img {\r
                ...
                `),d=v("br"),c=A(),f=v("br"),h=A(),m=se(_),g(t,"id","buildName"),g(t,"class","svelte-o7ons0"),g(r,"class","svelte-o7ons0"),g(l,"class","tooltip"),g(l,"id","bottom"),g(e,"class","currentBuild svelte-o7ons0"),J(e,"no-tooltip",n[8])},m(I,C){F(I,e,C),p(e,t),p(t,i),p(e,o),p(e,r),p(e,a),p(e,l),p(l,u),p(l,d),p(l,c),p(l,f),p(l,h),p(l,m),w=!0,T||(b=[N(r,"click",n[24]),N(r,"mouseenter",n[25]),N(r,"mouseleave",n[26])],T=!0)},p(I,C){(!w||C[0]&8)&&s!==(s=I[3].name+"")&&Re(i,s),(!w||C[0]&8)&&_!==(_=I[3].desc+"")&&Re(m,_),(!w||C[0]&256)&&J(e,"no-tooltip",I[8])},i(I){w||(I&&ve(()=>{w&&(y||(y=Ae(e,Ge,{duration:100},!0)),y.run(1))}),w=!0)},o(I){I&&(y||(y=Ae(e,Ge,{duration:100},!1)),y.run(0)),w=!1},d(I){I&&P(e),I&&y&&y.end(),T=!1,ge(b)}}}function lm(n){let e,t,s;return t=new rm({}),{c(){e=v("div"),pe(t.$$.fragment),g(e,"class","promptCont svelte-o7ons0")},m(i,o){F(i,e,o),fe(t,e,null),s=!0},p:te,i(i){s||(W(t.$$.fragment,i),s=!0)},o(i){G(t.$$.fragment,i),s=!1},d(i){i&&P(e),he(t)}}}function am(n){let e,t,s;return t=new em({}),{c(){e=v("div"),pe(t.$$.fragment),g(e,"class","promptCont svelte-o7ons0")},m(i,o){F(i,e,o),fe(t,e,null),s=!0},p:te,i(i){s||(W(t.$$.fragment,i),s=!0)},o(i){G(t.$$.fragment,i),s=!1},d(i){i&&P(e),he(t)}}}function um(n){let e,t,s;return t=new Jp({}),t.$on("buildLoad",n[28]),{c(){e=v("div"),pe(t.$$.fragment),g(e,"class","promptCont svelte-o7ons0")},m(i,o){F(i,e,o),fe(t,e,null),s=!0},p:te,i(i){s||(W(t.$$.fragment,i),s=!0)},o(i){G(t.$$.fragment,i),s=!1},d(i){i&&P(e),he(t)}}}function cm(n){let e,t,s;return t=new Yp({}),{c(){e=v("div"),pe(t.$$.fragment),g(e,"class","promptCont svelte-o7ons0")},m(i,o){F(i,e,o),fe(t,e,null),s=!0},p:te,i(i){s||(W(t.$$.fragment,i),s=!0)},o(i){G(t.$$.fragment,i),s=!1},d(i){i&&P(e),he(t)}}}function dm(n){let e,t,s;return t=new wp({}),{c(){e=v("div"),pe(t.$$.fragment),g(e,"class","promptCont svelte-o7ons0")},m(i,o){F(i,e,o),fe(t,e,null),s=!0},p:te,i(i){s||(W(t.$$.fragment,i),s=!0)},o(i){G(t.$$.fragment,i),s=!1},d(i){i&&P(e),he(t)}}}function fm(n){let e,t,s,i;function o(a){n[27](a)}let r={};return n[6]!==void 0&&(r.loadID=n[6]),t=new Wp({props:r}),$.push(()=>ke(t,"loadID",o)),t.$on("resetActions",n[17]),{c(){e=v("div"),pe(t.$$.fragment),g(e,"class","promptCont svelte-o7ons0")},m(a,l){F(a,e,l),fe(t,e,null),i=!0},p(a,l){const u={};!s&&l[0]&64&&(s=!0,u.loadID=a[6],Ee(()=>s=!1)),t.$set(u)},i(a){i||(W(t.$$.fragment,a),i=!0)},o(a){G(t.$$.fragment,a),i=!1},d(a){a&&P(e),he(t)}}}function hm(n){let e,t,s,i,o,r,a,l,u,d,c,f,h,_,m,y,w,T,b,I,C,O,L,U,V,D,B,R,re;ve(n[23]);let ne=Ve(n[15]),E=[];for(let S=0;S<ne.length;S+=1)E[S]=Kr(Yr(n,ne,S));let x=n[10]&&Qr(),le=Ve(n[15]),X=[];for(let S=0;S<le.length;S+=1)X[S]=Xr(Gr(n,le,S));let Q=n[5]&&xr(n),ae=n[3]&&Jr(n);c=new cp({}),h=new sm({}),w=new W_({}),b=new x_({}),C=new lp({}),L=new bp({});const k=[fm,dm,cm,um,am,lm],Y=[];function q(S,ie){return S[9]||S[4].share.ongoing?0:S[4].export.ongoing?1:S[4].save.ongoing?2:S[4].load.ongoing&&!S[6]?3:S[4].delete.ongoing?4:S[4].bonus.ongoing?5:-1}return~(V=q(n))&&(D=Y[V]=k[V](n)),{c(){for(let S=0;S<E.length;S+=1)E[S].c();e=Gt(),x&&x.c(),t=Gt(),s=A(),i=v("div");for(let S=0;S<X.length;S+=1)X[S].c();o=A(),r=v("div"),r.textContent=`${_m}`,a=A(),Q&&Q.c(),l=A(),u=v("main"),ae&&ae.c(),d=A(),pe(c.$$.fragment),f=A(),pe(h.$$.fragment),_=A(),m=v("div"),y=v("div"),pe(w.$$.fragment),T=A(),pe(b.$$.fragment),I=A(),pe(C.$$.fragment),O=A(),pe(L.$$.fragment),U=A(),D&&D.c(),g(i,"class","backgrounds"),g(r,"style","position: absolute; right: 0; padding: var(--u); font-size: calc(var(--u) * 2.5); color: var(--light);"),g(y,"class","eqCont svelte-o7ons0"),g(m,"class","calcBox svelte-o7ons0"),g(m,"id","calc"),g(u,"class","svelte-o7ons0")},m(S,ie){for(let we=0;we<E.length;we+=1)E[we]&&E[we].m(os.head,null);p(os.head,e),x&&x.m(os.head,null),p(os.head,t),F(S,s,ie),F(S,i,ie);for(let we=0;we<X.length;we+=1)X[we]&&X[we].m(i,null);F(S,o,ie),F(S,r,ie),F(S,a,ie),Q&&Q.m(S,ie),F(S,l,ie),F(S,u,ie),ae&&ae.m(u,null),p(u,d),fe(c,u,null),p(u,f),fe(h,u,null),p(u,_),p(u,m),p(m,y),fe(w,y,null),p(y,T),fe(b,y,null),p(m,I),fe(C,m,null),p(u,O),fe(L,u,null),p(u,U),~V&&Y[V].m(u,null),B=!0,R||(re=[N(sn,"storage",n[20]),N(sn,"wheel",n[21],{passive:!1}),N(sn,"keydown",n[22]),N(sn,"resize",n[23])],R=!0)},p(S,ie){if(ie[0]&32768){ne=Ve(S[15]);let ue;for(ue=0;ue<ne.length;ue+=1){const M=Yr(S,ne,ue);E[ue]?E[ue].p(M,ie):(E[ue]=Kr(M),E[ue].c(),E[ue].m(e.parentNode,e))}for(;ue<E.length;ue+=1)E[ue].d(1);E.length=ne.length}if(S[10]?x||(x=Qr(),x.c(),x.m(t.parentNode,t)):x&&(x.d(1),x=null),ie[0]&32896){le=Ve(S[15]);let ue;for(ue=0;ue<le.length;ue+=1){const M=Gr(S,le,ue);X[ue]?X[ue].p(M,ie):(X[ue]=Xr(M),X[ue].c(),X[ue].m(i,null))}for(;ue<X.length;ue+=1)X[ue].d(1);X.length=le.length}S[5]?Q?(Q.p(S,ie),ie[0]&32&&W(Q,1)):(Q=xr(S),Q.c(),W(Q,1),Q.m(l.parentNode,l)):Q&&(Le(),G(Q,1,1,()=>{Q=null}),Be()),S[3]?ae?(ae.p(S,ie),ie[0]&8&&W(ae,1)):(ae=Jr(S),ae.c(),W(ae,1),ae.m(u,d)):ae&&(Le(),G(ae,1,1,()=>{ae=null}),Be());let we=V;V=q(S),V===we?~V&&Y[V].p(S,ie):(D&&(Le(),G(Y[we],1,1,()=>{Y[we]=null}),Be()),~V?(D=Y[V],D?D.p(S,ie):(D=Y[V]=k[V](S),D.c()),W(D,1),D.m(u,null)):D=null)},i(S){B||(W(Q),W(ae),W(c.$$.fragment,S),W(h.$$.fragment,S),W(w.$$.fragment,S),W(b.$$.fragment,S),W(C.$$.fragment,S),W(L.$$.fragment,S),W(D),B=!0)},o(S){G(Q),G(ae),G(c.$$.fragment,S),G(h.$$.fragment,S),G(w.$$.fragment,S),G(b.$$.fragment,S),G(C.$$.fragment,S),G(L.$$.fragment,S),G(D),B=!1},d(S){S&&(P(s),P(i),P(o),P(r),P(a),P(l),P(u)),gt(E,S),P(e),x&&x.d(S),P(t),gt(X,S),Q&&Q.d(S),ae&&ae.d(),he(c),he(h),he(w),he(b),he(C),he(L),~V&&Y[V].d(),R=!1,ge(re)}}}let _m="3.18.0-alpha";function pm(n,e,t){let s,i,o,r,a,l,u,d,c,f,h,_;K(n,Ze,M=>t(3,i=M)),K(n,Z,M=>t(4,o=M)),K(n,dn,M=>t(10,r=M)),K(n,Ai,M=>t(19,a=M)),K(n,ds,M=>t(32,l=M)),K(n,Rt,M=>t(33,u=M)),K(n,Mn,M=>t(34,d=M)),K(n,bt,M=>t(35,c=M)),K(n,kt,M=>t(11,f=M)),K(n,nt,M=>t(12,h=M)),K(n,Ot,M=>t(36,_=M));let m,y,w,T=7,b=[.2,.3,.45,.6,.75,.85,.95,1,1.1,1.25,1.5,1.75,2,2.5,3,4,5],I=!1,C,O=new URLSearchParams(window.location.search).get("id");for(let M of f_){let Fe=`https://raw.githubusercontent.com/XT8SS/fc-sv/gh-pages/ff-data/${M}.json`;fetch(Fe).then(async be=>{if(be.status!=200){console.error(`Failed to fetch "${M}" data!
Status: ${be.status}`);return}j(Ot,_[M]=await be.json(),_)}).catch(be=>console.error(`Failed to initiate "${M}" data fetch!
${be}`))}fu(()=>{if(O)if(j(Z,o.load.ongoing=!0,o),!O.startsWith("-N"))j(Z,o.load.status=-1,o),j(Z,o.message="invalid_id",o);else{j(Z,o.load.status=0,o);let M=Qa(pn(mn,"builds"),Ka()),Fe=0;Ya(M).then(be=>{for(let Je in be.val()){if(Je==O){L(be.val()[Je],Je);break}else Fe==Object.keys(be.val()).length-1&&(j(Z,o.load.status=-1,o),j(Z,o.message="invalid_id",o));Fe++}}).catch(()=>{j(Z,o.load.status=-1,o),j(Z,o.message="firebase_fail",o)})}t(18,w=y>m),h[Object.keys(h)[0]]&&j(kt,f=!0,f)});function L(M,Fe){for(let be in M.eq){let Je=c[be]||ho;M.eq[be]&&M.eq[be]!=Je.name?d[be][M.eq[be]].querySelector("button").click():!M.eq[be]&&Je.name&&d[be][Je.name].querySelector("button").click()}for(let be of Yn){let Je=u[be]||_o;Je.name&&l[be][Je.name].querySelector("button").click()}setTimeout(()=>{for(let be of Yn)M.gear[be]&&l[be][M.gear[be]].querySelector("button").click();j(Z,o.load.ongoing=!1,o),j(Z,o.load.status=null,o),Fe&&(j(Ze,i=M,i),j(Ze,i.id=Fe,i),t(6,O=null))})}let U=[],V=[],D,B,R=9;for(let M=0;M<R;M++)U.push(`backgrounds/BG${M}.jpg`);function re(M){B=Math.floor(Math.random()*M.length)}re(U);function ne(){t(7,D=B),V.push(B)}ne(),function M(){setTimeout(()=>{if(re(U),!V.length)ne();else if(V.length>3&&(V=V.slice(1)),!V.includes(B))ne();else{let Fe=[...Array(R).keys()].filter(be=>!V.includes(be));re(Fe),ne()}document.hasFocus&&M()},45e3)}();function E(){C=setTimeout(()=>{t(5,I=!1)},2e3)}function x(){clearTimeout(C),t(5,I=!0),E()}function le(){j(Z,o.export.status=null,o),j(Z,o.export.ongoing=!1,o),j(Z,o.save.status=null,o),j(Z,o.save.ongoing=!1,o),j(Z,o.load.status=null,o),j(Z,o.load.ongoing=!1,o),j(Z,o.delete.status=null,o),j(Z,o.delete.ongoing=!1,o),j(Z,o.share.ongoing=!1,o),j(Z,o.message="",o)}let X=!1;const Q=M=>{if(M.key=="builds")if(M.url.includes("ls=true")){j(nt,h=JSON.parse(M.newValue),h),j(kt,f=Object.keys(JSON.parse(M.newValue)).length>0,f),le();let Fe=Object.keys(JSON.parse(M.oldValue)).filter(be=>!Object.keys(JSON.parse(M.newValue)).includes(be))[0];Fe&&i&&Fe==i.name&&j(Ze,i=null,i)}else window.localStorage.setItem("builds",JSON.stringify(h))},ae=M=>{let Fe=M.wheelDeltaY;if(M.ctrlKey){if(M.preventDefault(),b[T]==.2&&Fe<0||b[T]==5&&Fe>0)return;Fe>0?t(2,T++,T):t(2,T--,T),x()}},k=M=>{M.ctrlKey&&(M.key=="-"||M.key=="+"||M.code=="Equal"||M.key=="0")&&(M.preventDefault(),(M.key=="+"||M.code=="Equal")&&b[T]!=5?t(2,T++,T):M.key=="-"&&b[T]!=.2?t(2,T--,T):M.key=="0"&&b[T]!=1&&t(2,T=7),x()),r&&p_(M)};function Y(){t(0,m=sn.outerHeight),t(1,y=sn.outerWidth)}const q=()=>{r||j(Z,o.share.ongoing=!0,o)},S=()=>t(8,X=!0),ie=()=>t(8,X=!1);function we(M){O=M,t(6,O)}const ue=M=>L(M.detail.build,M.detail.id);return n.$$.update=()=>{if(n.$$.dirty[0]&524291&&(y||m)&&(t(18,w=y>m),a))for(let M of a)po(M.node,M.itemName);n.$$.dirty[0]&262148&&(w?document.documentElement.style.setProperty("--u",`${.75*b[T]}vh`):document.documentElement.style.setProperty("--u","0.75vh")),n.$$.dirty[0]&16&&t(9,s=o.export.status||o.save.status||o.load.status||o.delete.status),n.$$.dirty[0]&16&&j(dn,r=o.export.ongoing||o.save.ongoing||o.load.ongoing||o.delete.ongoing||o.share.ongoing||o.bonus.ongoing,r),n.$$.dirty[0]&8&&(document.title=(i?i.name+" - ":"")+"Fantastic Calculator")},[m,y,T,i,o,I,O,D,X,s,r,f,h,b,L,U,x,le,w,a,Q,ae,k,Y,q,S,ie,we,ue]}class mm extends De{constructor(e){super(),Ne(this,e,pm,hm,me,{},null,[-1,-1])}}new mm({target:document.body});
